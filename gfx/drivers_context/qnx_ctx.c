...
static void *gfx_ctx_qnx_init(void *video_driver)
{
   ...
   KINGSN_LOG("Initializing screen context...\n");
   if (!screen_ctx)
   {
      ...
      {
         KINGSN_ERR("screen_request_events failed.\n");
         goto screen_error;
      }

      if (navigator_request_events(0) != BPS_SUCCESS)
      {
         KINGSN_ERR("navigator_request_events failed.\n");
         goto screen_error;
      }

      if (navigator_rotation_lock(false) != BPS_SUCCESS)
      {
         KINGSN_ERR("navigator_location_lock failed.\n");
         goto screen_error;
      }
   }
   ...
   if(!screen_win)
   {
      ...
      {
             KINGSN_ERR("screen_create_window failed:.\n");
	     goto error;
      }
   }
   ...
   {
      KINGSN_ERR("screen_set_window_property_iv [SCREEN_PROPERTY_FORMAT] failed.\n");
      goto error;
   }
   ...
   {
      KINGSN_ERR("screen_set_window_property_iv [SCREEN_PROPERTY_USAGE] failed.\n");
      goto error;
   }
   ...
   {
      KINGSN_ERR("screen_get_window_property_pv [SCREEN_PROPERTY_DISPLAY] failed.\n");
      goto error;
   }
   ...
   {
      KINGSN_ERR("screen_get_window_property_iv [SCREEN_PROPERTY_SIZE] failed.\n");
      goto error;
   }
   ...
   {
      KINGSN_ERR("screen_get_display_property_pv [SCREEN_PROPERTY_MODE] failed.\n");
      goto error;
   }
   ...
   {
      KINGSN_ERR("screen_get_window_property_iv [SCREEN_PROPERTY_BUFFER_SIZE] failed.\n");
      goto error;
   }
   ...
   {
      KINGSN_ERR("Navigator returned an unexpected orientation angle.\n");
      goto error;
   }
   ...
   {
      KINGSN_ERR("screen_set_window_property_iv [SCREEN_PROPERTY_BUFFER_SIZE] failed.\n");
      goto error;
   }
   ...
   {
      KINGSN_ERR("screen_set_window_property_iv [SCREEN_PROPERTY_ROTATION] failed.\n");
      goto error;
   }
#endif
   ...
   {
      KINGSN_ERR("screen_create_window_buffers failed.\n");
      goto error;
   }
...
static int dpi_get_density(qnx_ctx_data_t *qnx)
{
    ...
    {
       KINGSN_ERR("screen_get_display_property_iv [SCREEN_PROPERTY_DPI] failed.\n");
       return -1;
    }
