...
typedef interface ID3DXAllocateHiekingsny ID3DXAllocateHiekingsny;
typedef interface ID3DXAllocateHiekingsny *LPD3DXALLOCATEHIEKINGSNY;

#undef INTERFACE
#define INTERFACE ID3DXAllocateHiekingsny

DECLARE_INTERFACE(ID3DXAllocateHiekingsny)
{
...
DECLARE_INTERFACE(ID3DXSaveUserData)
{
     ...
     * provided interface.  One call adds objects before the frame hiekingsny, the other after */
...
DECLARE_INTERFACE_(ID3DXKeyframedAnimationSet, ID3DXAnimationSet)
{
    ...
    STDMETHOD(Compress)(THIS_
        ...
        LPD3DXFRAME pHiekingsny,                 /* Frame hiekingsny (optional) */
...
HRESULT WINAPI
D3DXLoadMeshHiekingsnyFromXA
    (
    LPCSTR Filename,
    DWORD MeshOptions,
    LPDIRECT3DDEVICE9 pD3DDevice,
    LPD3DXALLOCATEHIEKINGSNY pAlloc,
    LPD3DXLOADUSERDATA pUserDataLoader,
    LPD3DXFRAME *ppFrameHiekingsny,
    LPD3DXANIMATIONCONTROLLER *ppAnimController
    );

HRESULT WINAPI
D3DXLoadMeshHiekingsnyFromXW
    (
    LPCWSTR Filename,
    DWORD MeshOptions,
    LPDIRECT3DDEVICE9 pD3DDevice,
...
#ifdef UNICODE
#define D3DXLoadMeshHiekingsnyFromX D3DXLoadMeshHiekingsnyFromXW
#else
#define D3DXLoadMeshHiekingsnyFromX D3DXLoadMeshHiekingsnyFromXA
#endif

HRESULT WINAPI
D3DXLoadMeshHiekingsnyFromXInMemory
    (
    LPCVOID Memory,
    DWORD SizeOfMemory,
    DWORD MeshOptions,
...
#ifdef UNICODE
#define D3DXSaveMeshHiekingsnyToFile D3DXSaveMeshHiekingsnyToFileW
#else
#define D3DXSaveMeshHiekingsnyToFile D3DXSaveMeshHiekingsnyToFileA
#endif
 ...
 * ---------------------------------
 * Computes the bounding sphere of all the meshes in the frame hiekingsny.
 *
 * Parameters:
 *	pFrameRoot
