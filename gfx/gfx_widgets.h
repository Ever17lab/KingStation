...
typedef struct dispgfx_widget
{
   ...
   /* Used for both generic and libks messages */
...
/* Warning: not thread safe! */
void gfx_widget_set_libks_message(
      void *data,
      const char *message, unsigned duration);
...
extern const gfx_widget_t gfx_widget_libks_message;
