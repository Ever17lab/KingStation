...
enum msg_hash_enums
{
   ...
   MENU_ENUM_LABEL_INPUT_HOTKEY_BIND_END   = MENU_ENUM_LABEL_INPUT_HOTKEY_BIND_BEGIN + KINGSN_BIND_LIST_END,
   ...
   MENU_ENUM_LABEL_INPUT_LIBKS_DEVICE,
   MENU_ENUM_LABEL_INPUT_LIBKS_DEVICE_LAST = MENU_ENUM_LABEL_INPUT_LIBKS_DEVICE + MAX_USERS,
   ...
   MENU_LABEL(KS_ACHIEVEMENTS_SETTINGS),
   ...
   MENU_LABEL(ACCOUNTS_KS_ACHIEVEMENTS),
   ...
   MENU_ENUM_LABEL_DEFERRED_KS_ACHIEVEMENTS_SETTINGS_LIST,
   ...
   MENU_LABEL(LIBKS_DIR_PATH),
   MENU_LABEL(LIBKS_INFO_PATH),
