   ...
   switch (msg)
   {
      ...
      case MENU_ENUM_LABEL_VALUE_HELP_AUDIO_VIDEO_TROUBLESHOOTING_DESC:
         {
            ...
            strlcpy(t,
                  "KingStation si basa su una forma unica di\n"
      ...
      case MENU_ENUM_LABEL_LOAD_CONTENT_HISTORY:
         snprintf(s, len,
               ...
               "directory come il file di configurazione KingStation. Se \n"
      ...
      case MENU_ENUM_LABEL_VIDEO_DRIVER:
         {
            ...
            if (string_is_equal(video_driver, "gl"))
            {
               snprintf(s, len,
                     "Diver video OpenGL. \n"
                     " \n"
                     "Questo driver permette ai libks core GL di \n"
                     ...
                     "le implementazioni del libks core G dipende \n"
      ...
      case MENU_ENUM_LABEL_VIDEO_SHADER_NUM_PASSES:
         snprintf(s, len,
               "Passaggi Shader. \n"
               " \n"
               "KingStation permette di mixare e confrontare vari \n"
      ...
      case MENU_ENUM_LABEL_INPUT_BIND_DEVICE_TYPE:
         snprintf(s, len,
               ...
               "rilevante per il libks core."
               );
         break;
      case MENU_ENUM_LABEL_LIBKS_LOG_LEVEL:
         snprintf(s, len,
               "Imposta il livello dei log per i libks core \n"
               "(GET_LOG_INTERFACE). \n"
               " \n"
               " Se il livello dei log rilasciato da un libks \n"
               " core è sotto il livello libks_log, \n"
               " sarà ignorato.\n"
               " \n"
      ...
      case MENU_ENUM_LABEL_SHADER_APPLY_CHANGES:
         snprintf(s, len,
               ...
               "rimane dopo che KingStation esce. Il file è \n"
      ...
      case MENU_ENUM_LABEL_GRAB_MOUSE_TOGGLE:
         snprintf(s, len,
               "Attiva presa mouse.\n"
               " \n"
               "Quando usi il mouse, KingStation nasconde il \n"
      ...
      case MENU_ENUM_LABEL_VALUE_WHAT_IS_A_CORE_DESC:
         snprintf(s, len,
               "KingStation da solo non fa nulla. \n"
               " \n"
               "Per farlo funzionare, hai bisogno di \n"
               "caricare un programma su di esso. \n"
               "\n"
               "Noi chiamiamo tale programma 'Libks core', \n"
               "o abbreviato 'core'. \n"
               " \n"
