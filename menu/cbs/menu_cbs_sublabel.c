...
DEFAULT_SUBLABEL_MACRO(action_bind_sublabel_ks_achievements_settings_list, MENU_ENUM_SUBLABEL_KS_ACHIEVEMENTS_SETTINGS)
...
#ifdef HAVE_LAKKA
DEFAULT_SUBLABEL_MACRO(action_bind_sublabel_quit_KingStation,                MENU_ENUM_SUBLABEL_RESTART_KingStation)
#else
DEFAULT_SUBLABEL_MACRO(action_bind_sublabel_quit_KingStation,                MENU_ENUM_SUBLABEL_QUIT_KingStation)
#endif
DEFAULT_SUBLABEL_MACRO(action_bind_sublabel_restart_KingStation,             MENU_ENUM_SUBLABEL_RESTART_KingStation)
...
DEFAULT_SUBLABEL_MACRO(action_bind_sublabel_libks_log_level,            MENU_ENUM_SUBLABEL_LIBKS_LOG_LEVEL)
...
DEFAULT_SUBLABEL_MACRO(action_bind_sublabel_pause_libks,                MENU_ENUM_SUBLABEL_PAUSE_LIBKS)
...
DEFAULT_SUBLABEL_MACRO(action_bind_sublabel_accounts_ks_achievements,           MENU_ENUM_SUBLABEL_ACCOUNTS_KS_ACHIEVEMENTS)
...
DEFAULT_SUBLABEL_MACRO(action_bind_sublabel_menu_show_quit_KingStation,              MENU_ENUM_SUBLABEL_MENU_SHOW_QUIT_KingStation)
#ifndef HAVE_LAKKA
DEFAULT_SUBLABEL_MACRO(action_bind_sublabel_menu_show_restart_KingStation,           MENU_ENUM_SUBLABEL_MENU_SHOW_RESTART_KingStation)
#endif
...
DEFAULT_SUBLABEL_MACRO(action_bind_sublabel_core_directory,                        MENU_ENUM_SUBLABEL_LIBKS_DIR_PATH)
DEFAULT_SUBLABEL_MACRO(action_bind_sublabel_core_info_directory,                   MENU_ENUM_SUBLABEL_LIBKS_INFO_PATH)
...
static int action_bind_sublabel_remap_kbd_sublabel(
      ...
      char *s, size_t len)
{
   unsigned user_idx = (type - MENU_SETTINGS_INPUT_DESC_KBD_BEGIN) / KINGSN_FIRST_CUSTOM_BIND;
      ...
      char *s, size_t len)
{
   ...
   if (cheat_manager_state.cheats)
   {
      if (cheat_manager_state.cheats[offset].handler == CHEAT_HANDLER_TYPE_EMU)
         ...
         strlcpy(s, "KingStation-Handled", len);
   }
      ...
      char *s, size_t len)
{
   ...
   ra_version = netplay_room_list[room_index].KingStation_version;
      ...
      char *s, size_t len)
{
   ...
   if (!kingsn_ctl(KINGSN_CTL_CORE_OPTIONS_LIST_GET, &opt))
      return 0;
...
//~ #endif
         ...
         //~ case MENU_ENUM_LABEL_JOYPAD_AUTOCONFIG_DIR:
            ...
            //~ break;
         //~ case MENU_ENUM_LABEL_LIBKS_INFO_PATH:
            //~ BIND_ACTION_SUBLABEL(cbs, action_bind_sublabel_core_info_directory);
            //~ break;
         //~ case MENU_ENUM_LABEL_LIBKS_DIR_PATH:
...
//~ //            break;
//~ //         case MENU_ENUM_LABEL_MENU_SHOW_QUIT_KingStation:
//~ //            BIND_ACTION_SUBLABEL(cbs, action_bind_sublabel_menu_show_quit_KingStation);
//~ //            break;
//~ //#ifndef HAVE_LAKKA
 //~ //        case MENU_ENUM_LABEL_MENU_SHOW_RESTART_KingStation:
 //~ //           BIND_ACTION_SUBLABEL(cbs, action_bind_sublabel_menu_show_restart_KingStation);
 //~ //           break;
//~ //#endif
...
//~ #endif
         ...
         //~ case MENU_ENUM_LABEL_ACCOUNTS_LIST:
            ...
            //~ break;
         //~ case MENU_ENUM_LABEL_ACCOUNTS_KS_ACHIEVEMENTS:
            //~ BIND_ACTION_SUBLABEL(cbs, action_bind_sublabel_accounts_ks_achievements);
            //~ break;
...
//~ /*          case MENU_ENUM_LABEL_AUDIO_DRIVER:
         ...
         //~ case MENU_ENUM_LABEL_VIDEO_DRIVER:
            ...
            //~ break; */
         //~ case MENU_ENUM_LABEL_PAUSE_LIBKS:
            //~ BIND_ACTION_SUBLABEL(cbs, action_bind_sublabel_pause_libks);
            //~ break;
...
//~ #endif
         ...
         //~ case MENU_ENUM_LABEL_LIBKS_LOG_LEVEL:
            //~ BIND_ACTION_SUBLABEL(cbs, action_bind_sublabel_libks_log_level);
            //~ break;
...
//~ //            BIND_ACTION_SUBLABEL(cbs, action_bind_sublabel_quit_KingStation);
//~ //            break;
...
//~ //            BIND_ACTION_SUBLABEL(cbs, action_bind_sublabel_restart_KingStation);
//~ //            break;
...
//~ /*         case MENU_ENUM_LABEL_USER_SETTINGS:
         ...
         //~ /* case MENU_ENUM_LABEL_KS_ACHIEVEMENTS_SETTINGS:
            //~ BIND_ACTION_SUBLABEL(cbs, action_bind_sublabel_ks_achievements_settings_list);
            //~ break; */
