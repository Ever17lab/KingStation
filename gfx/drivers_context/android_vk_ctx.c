      ...
      bool *resize, unsigned *width, unsigned *height)
{
   ...
   *resize    = and->vk.need_new_swapchain;
   ...
   {
      KINGSN_LOG("[Android]: Resizing (%u x %u) -> (%u x %u).\n",
      ...
      unsigned width, unsigned height)
{
   ...
   KINGSN_LOG("[Android]: Native window size: %u x %u.\n", and->width, and->height);
   if (!vulkan_create_swapchain(&and->vk, and->width, and->height, and->swap_interval))
   {
      KINGSN_ERR("[Android]: Failed to update swapchain.\n");
      return false;
   }
      ...
      bool fullscreen)
{
   ...
   {
      KINGSN_ERR("[Android]: Failed to create surface.\n");
      return false;
   }
...
static void android_gfx_ctx_vk_set_swap_interval(void *data, int swap_interval)
{
   ...
   {
      KINGSN_LOG("[Vulkan]: Setting swap interval: %u.\n", swap_interval);
