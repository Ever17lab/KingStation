      ...
      const char* path, unsigned int track_index)
{
   ...
   intfstream_t *cue_stream                 = intfstream_open_file(path, KS_VFS_FILE_ACCESS_READ, KS_VFS_FILE_ACCESS_HINT_NONE);
   ...
   track = cdfs_wrap_stream(intfstream_open_file(
            track_path, KS_VFS_FILE_ACCESS_READ,
            KS_VFS_FILE_ACCESS_HINT_NONE), track_offset);
