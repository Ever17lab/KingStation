...
{
   unsigned i;
   struct kingsn_main_wrap *params = NULL;
...
#ifndef IS_SALAMANDER
#ifdef VITA
   params          = (struct kingsn_main_wrap*)params_data;
   params->verbose = true;
#endif
...
static void frontend_psp_exec(const char *path, bool should_load_game)
{
   ...
   {
      argp[args] = '\0';
      strlcat(argp + args, path_get(KINGSN_PATH_CONTENT), sizeof(argp) - args);
...
#if defined(VITA)
   KINGSN_LOG("Attempt to load executable: %d [%s].\n", args, argp);
#ifdef IS_SALAMANDER
   ...
   if (strstr(boot_params,"psgm:play"))
   {
      ...
      if (param1 != NULL && param2 != NULL)
      {
         ...
         {
            KINGSN_LOG("Boot params are too long. Continue normal boot.");
         }
      }
      else
      {
         KINGSN_LOG("Required boot params missing. Continue nornal boot.");
      }
      
      int ret =  sceAppMgrLoadExec(core_name, args == 0 ? NULL : (char * const*)((const char*[]){argp, 0}), NULL);
      KINGSN_LOG("Attempt to load executable: [%d].\n", ret);
   }
   else
#endif
   {
...
#ifdef VITA
enum ks_language psp_get_ks_lang_from_langid(int langid)
{
   switch (langid)
   {
   case SCE_SYSTEM_PARAM_LANG_JAPANESE:
      return KS_LANGUAGE_JAPANESE;
   case SCE_SYSTEM_PARAM_LANG_FRENCH:
      return KS_LANGUAGE_FRENCH;
   case SCE_SYSTEM_PARAM_LANG_SPANISH:
      return KS_LANGUAGE_SPANISH;
   case SCE_SYSTEM_PARAM_LANG_GERMAN:
      return KS_LANGUAGE_GERMAN;
   case SCE_SYSTEM_PARAM_LANG_ITALIAN:
      return KS_LANGUAGE_ITALIAN;
   case SCE_SYSTEM_PARAM_LANG_DUTCH:
      return KS_LANGUAGE_DUTCH;
   case SCE_SYSTEM_PARAM_LANG_PORTUGUESE_PT:
      return KS_LANGUAGE_PORTUGUESE_PORTUGAL;
   case SCE_SYSTEM_PARAM_LANG_RUSSIAN:
      return KS_LANGUAGE_RUSSIAN;
   case SCE_SYSTEM_PARAM_LANG_KOREAN:
      return KS_LANGUAGE_KOREAN;
   case SCE_SYSTEM_PARAM_LANG_CHINESE_T:
      return KS_LANGUAGE_CHINESE_TRADITIONAL;
   case SCE_SYSTEM_PARAM_LANG_CHINESE_S:
      return KS_LANGUAGE_CHINESE_SIMPLIFIED;
   case SCE_SYSTEM_PARAM_LANG_POLISH:
      return KS_LANGUAGE_POLISH;
   case SCE_SYSTEM_PARAM_LANG_PORTUGUESE_BR:
      return KS_LANGUAGE_PORTUGUESE_BRAZIL;
   case SCE_SYSTEM_PARAM_LANG_TURKISH:
      return KS_LANGUAGE_TURKISH;
#if 0
   /* TODO/FIXME - this doesn't seem to actually exist */
   case SCE_SYSTEM_PARAM_LANG_SLOVAK:
      return KS_LANGUAGE_SLOVAK;
#endif
...
enum ks_language frontend_psp_get_user_language(void)
{
   int langid;
   sceAppUtilSystemParamGetInt(SCE_SYSTEM_PARAM_ID_LANG, &langid);
   return psp_get_ks_lang_from_langid(langid);
}
