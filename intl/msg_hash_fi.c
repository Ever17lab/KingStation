       ...
       switch (idx)
       {
          ...
          case KINGSN_GAME_FOCUS_TOGGLE:
             snprintf(s, len,
                   "Toggles game focus.\n"
                   " \n"
                   "When a game has focus, KingStation will both disable \n"
          ...
          case KINGSN_QUIT_KEY:
             snprintf(s, len,
                   "Key to exit KingStation cleanly. \n"
                   " \n"
                   "Killing it in any hard way (SIGKILL, etc.) will \n"
                   "terminate KingStation without saving RAM, etc."
#ifdef __unix__
    ...
    switch (msg)
    {
        case MENU_ENUM_LABEL_ACCOUNTS_KS_ACHIEVEMENTS:
            snprintf(s, len, "Login details for your \n"
                    ...
                    " \n"
                    "Visit ksachievements.org and sign up \n"
                    "for a free account. \n"
                    " \n"
        ...
        case MENU_ENUM_LABEL_SORT_SAVESTATES_ENABLE:
            snprintf(s, len, "Sort save states in folders \n"
                    "named after the libks core used.");
            break;
        ...
        case MENU_ENUM_LABEL_FILE_BROWSER_CORE:
            snprintf(s, len,
                     "Libks core. \n"
                             " \n"
                             "Select this file to have KingStation load this core.");
            break;
        ...
        case MENU_ENUM_LABEL_CACHE_DIRECTORY:
            snprintf(s, len,
                     "Cache Directory. \n"
                             " \n"
                             "Content decompressed by KingStation will be \n"
                             "temporarily extracted to this directory.");
            break;
        case MENU_ENUM_LABEL_HISTORY_LIST_ENABLE:
            snprintf(s, len,
                     "If enabled, every content loaded \n"
                             "in KingStation will be automatically \n"
        ...
        case MENU_ENUM_LABEL_VALUE_HELP_AUDIO_VIDEO_TROUBLESHOOTING_DESC:
            {
                ...
                char u[501];
                const char *t =
                        "KingStation relies on an unique form of\n"
        ...
        case MENU_ENUM_LABEL_LOAD_CONTENT_HISTORY:
            snprintf(s, len,
                     "Loading content from history. \n"
                             " \n"
                             "As content is loaded, content and libks \n"
                             "core combinations are saved to history. \n"
                             " \n"
                             "The history is saved to a file in the same \n"
                             "directory as the KingStation config file. If \n"
        ...
        case MENU_ENUM_LABEL_VIDEO_DRIVER:
            {
               ...
               if (string_is_equal(video_driver, "gl"))
               {
                  snprintf(s, len,
                        "OpenGL Video driver. \n"
                        " \n"
                        "This driver allows libks GL cores to  \n"
                        "be used in addition to software-rendered \n"
                        "core implementations.\n"
                        " \n"
                        "Performance for software-rendered and \n"
                        "libks GL core implementations is \n"
               ...
               else if (string_is_equal(video_driver, "sdl2"))
               {
                  snprintf(s, len,
                        ...
                        "driver.\n"
                        " \n"
                        "Performance for software-rendered libks \n"
        ...
        case MENU_ENUM_LABEL_INPUT_BIND_DEVICE_TYPE:
            snprintf(s, len,
                     "Input Device Type. \n"
                             ...
                             "relevant for the libks core itself.");
            break;
        case MENU_ENUM_LABEL_LIBKS_LOG_LEVEL:
            snprintf(s, len,
                     "Sets log level for libks cores \n"
                             "(GET_LOG_INTERFACE). \n"
                             " \n"
                             " If a log level issued by a libks \n"
                             " core is below libks_log level, it \n"
                             " is ignored.\n"
                             " \n"
        ...
        case MENU_ENUM_LABEL_SHADER_APPLY_CHANGES:
            snprintf(s, len,
                     "Apply Shader Changes. \n"
                             ...
                             "persists after KingStation exits. The file is \n"
        ...
        case MENU_ENUM_LABEL_ENABLE_HOTKEY:
            snprintf(s, len,
                     "Enable other hotkeys.\n"
                             ...
                             "at the same time. \n"
                             " \n"
                             "This is useful for KS_KEYBOARD centric \n"
        ...
        case MENU_ENUM_LABEL_VIDEO_ROTATION:
            snprintf(s, len,
                     "Forces a certain rotation \n"
                             ...
                             "the libks core sets (see Video Allow\n"
                             "Rotate).");
            break;
        ...
        case MENU_ENUM_LABEL_FASTFORWARD_RATIO:
            snprintf(s, len,
                     "Fastforward ratio.\n"
                             ...
                             "cap).\n"
                             " \n"
                             "KingStation will go to sleep to ensure that \n"
        ...
        case MENU_ENUM_LABEL_VIDEO_MONITOR_INDEX:
            snprintf(s, len,
                     "Which monitor to prefer.\n"
                             ...
                             "monitor), suggests KingStation to use that \n"
                             "particular monitor.");
            break;
      ...
      case MENU_ENUM_LABEL_VIDEO_CTX_SCALING:
        ...
        case MENU_ENUM_LABEL_NETPLAY_NICKNAME:
            snprintf(s, len,
                     "The username of the person running KingStation. \n"
        ...
        case MENU_ENUM_LABEL_VALUE_WHAT_IS_A_CORE_DESC:
            snprintf(s, len,
                     "KingStation by itself does nothing. \n"
                            " \n"
                            "To make it do things, you need to \n"
                            "load a program into it. \n"
                            "\n"
                            "We call such a program 'Libks core', \n"
                            "or 'core' in short. \n"
                            " \n"
...
#ifdef HAVE_MENU
static const char *menu_hash_to_str_fi_label_enum(enum msg_hash_enums msg)
{
   if (msg <= MENU_ENUM_LABEL_INPUT_HOTKEY_BIND_END &&
         msg >= MENU_ENUM_LABEL_INPUT_HOTKEY_BIND_BEGIN)
   {
...
{
#ifdef HAVE_MENU
    const char *ret = menu_hash_to_str_fi_label_enum(msg);
