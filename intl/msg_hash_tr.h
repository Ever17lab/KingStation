...
MSG_HASH(
   ...
   "KingStation için eklentiler, bileşenler ve içerikler indir."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Libks Kütüphanesinin Dinamik Çalışma Zamanı Yükleniyor"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Görünüm penceresinin X ekseni konumunu tanımlamak için kullanılan özel görünüm alanı ofseti. 'Tam sayı Ölçeği' etkinse bunlar yok sayılır."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Görünüm penceresinin Y ekseni konumunu tanımlamak için kullanılan özel görünüm alanı ofseti. 'Tam sayı Ölçeği' etkinse bunlar yok sayılır."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Daha fazla video takılma riski pahasına gecikmeyi azaltır. V-Sync'den sonra gecikme ekler (ms cinsinden)."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "KingStation tarafından desteklenen azami kullanıcı sayısı."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "KingStation'da girdi yoklamanın nasıl yapıldığını etkileyin. 'Erken' veya 'Geç' olarak ayarlamak, yapılandırmanıza bağlı olarak daha az gecikmeye neden olabilir."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Bu port için kontrolcüleri yapılandır."
   )
...
MSG_HASH(
   ...
   "KingStation üstünden çıkmak için çık tuşuna iki kez basılması gerekir."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Tüm kayıt verilerinin ve yapılandırma dosyalarının diske atılmasını sağlayarak KingStation'ı kapatır."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Cihazınız ve KingStation yapılandırması hakkındaki teşhis bilgilerini analiz için sunucularımıza gönderir."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Fareyi yakalar veya serbest bırakır. Yakalandığında, sistem imleci gizlenir ve KingStation görüntüleme penceresiyle sınırlandırılarak göreceli fare girişi iyileştirilir."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Önden-Git için KingStation çekirdeğinin ikincil örneğini kullanın. Yükleme durumu nedeniyle ses sorunlarını önler."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Bazı çekirdeklerin bir kapatma özelliği vardır, sahte bir çekirdek yüklemek KingStation'ın kapanmasını önler."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Gerekli çekirdek yüklü olduğu halde, içerik başlatılırken KingStation'ı yeniden başlat. Bu, yükleme süresinin uzaması uğruna, sistem kararlılığını arttırabilir."
   )
#endif
MSG_HASH(
...
MSG_HASH(
   ...
   "Tüm temel çekirdek seçeneklerini ortak bir ayarlar dosyasına (KingStation-core-options.cfg) kaydeder. Devre dışı bırakıldığında, her çekirdek için seçenekler KingStation'ın 'Yapılandırma' dizinindeki çekirdeğe özgü ayrı bir klasöre/dosyaya kaydedilir."
   )
...
MSG_HASH(
   ...
   "Kalıcı olmayan SaveRAM'i düzenli aralıklarla (saniye cinsinden) otomatik olarak kaydeder."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "İçerik kapatıldığında otomatik olarak durum kaydı oluşturur. 'Durumu Otomatik Olarak Yükle' etkinse KingStation bu durum kaydını otomatik olarak yükler."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Kalıcı olmayan SaveRAM dosyalarını arşivlenmiş biçimde yazın. Artan kaydetme/yükleme süreleri (önemsizce) pahasına dosya boyutunu önemli ölçüde azaltır. Not: Yalnızca standart libks SaveRAM arabirimi üzerinden kaydetmeyi sağlayan çekirdekler için geçerlidir."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Dosyaya giriş yaparken, çıktıyı her KingStation oturumundan yeni bir zaman damgalı dosyaya yönlendirir. Devre dışı bırakılırsa, KingStation yeniden başlatıldığında her günlüğün üzerine yazılır."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "KingStation ve çekirdekler için performans sayaçları. Sayaç verileri, sistem darboğazlarının belirlenmesine ve performansın ince ayarının yapılmasına yardımcı olabilir."
   )
...
MSG_HASH(
   ...
   "Kare süresi sayacını etkileyen ayarları yapın (yalnızca baskın video devre dışı bırakıldığında etkindir)."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "KingStation'ta menü ögelerinin görünürlüğünü aç/kapat."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Devre dışı bırakılırsa, KingStation menüsü değiştirildiğinde, içerik arka planda çalışmaya devam eder."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "İçeriği kapatırken KingStation'tan otomatik olarak çıkın. 'CLI' yalnızca içerik komut satırı aracılığıyla başlatıldığında çıkar."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "KingStation etkin pencere olmadığında oyunu duraklat."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "KingStation Çıkışı Göster"
   )
MSG_HASH(
   MENU_ENUM_SUBLABEL_MENU_SHOW_QUIT_KingStation,
   "'KingStation Çıkış' seçeneğini göster/gizle."
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_MENU_SHOW_RESTART_KingStation,
   "KingStation Yeniden Başlat'ı Göster"
   )
MSG_HASH(
   MENU_ENUM_SUBLABEL_MENU_SHOW_RESTART_KingStation,
   "'KingStation Yeniden Başlat' seçeneğini göster/gizle."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Keşfet Sekmesini Göster"
   )
MSG_HASH(
   MENU_ENUM_SUBLABEL_CONTENT_SHOW_EXPLORE,
   "Ana menüde içerik keşfet sekmesini göster."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "'Ekran Kaydı Başlat' seçeneğini göster/gizle."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "'Kontrolcüler' seçeneğini göster/gizle."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Kayıtlı Çekirdek Özelleştirmelerini Göster"
   )
MSG_HASH(
   MENU_ENUM_SUBLABEL_QUICK_MENU_SHOW_SAVE_CORE_OVERRIDES,
   "'Kayıtlı Çekirdek Özelleştirmeleri' seçeneğini göster/gizle."
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_QUICK_MENU_SHOW_SAVE_GAME_OVERRIDES,
   "Kayıtlı Oyun Özelleştirmelerini Göster"
   )
MSG_HASH(
   MENU_ENUM_SUBLABEL_QUICK_MENU_SHOW_SAVE_GAME_OVERRIDES,
   "'Kayıtlı Oyun Özelleştirmeleri' seçeneğini göster/gizle."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Klasik oyunlarda başarılar kazanın. Daha fazla bilgi için 'https://ksachievements.org' adresini ziyaret edin."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Libks buildbot'taki temel güncelleyici dizinine URL."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Libks buildbot'taki varlık güncelleme dizini URL."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Kullanıcı oynatma listelerindeki girdileri adlandırmasına izin verin."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Kullanıcının girdileri listelerden kaldırmasına izin ver."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Oynatma listesi girdilerinde ilişkilendirilmiş çekirdek (varsa) ne zaman etiketleneceğini belirle. NOT: Oynatma listesi alt etiketleri etkinleştirildiğinde bu ayar dikkate alınmaz."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Oynatma listesi alt etiketlerinde hangi günlük kaydının görüntüleneceğini seçer. (İlgili çalışma zamanı günlüğünün 'Durum Kaydı' seçenekler menüsünden etkinleştirilmesi gerektiğini unutmayın)"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Devre dışı bırakıldığında, içerik yalnızca eklentilerini destekleyen bir çekirdek varsa oynatma listelerine eklenir. Etkinleştirildiğinde ne olursa olsun oynatma listesine ekleyecektir. Böylece, tarama sonrası ihtiyacınız olan çekirdeği yükleyebilirsiniz."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "KingStation tarafından kullanılan menü varlıkları bu dizinde saklanır."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Tüm durum kayıtlarını bu dizine kaydedin. Ayarlanmamışsa, içerik dosyasının çalışma dizinine kaydetmeye çalışır."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Ana bilgisayar (sunucu) kipinde netplay etkinleştirilir."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Mevcut hileleri bir kayıt dosyası olarak kaydedin."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "KingStation için farklı bir simge teması seçin."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "KingStation'ı Güncelle (gecelik sürüm)"
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_QT_UPDATE_KingStation_FINISHED,
   "KingStation başarıyla güncellendi. Değişikliklerin etkili olması için lütfen yeniden başlatın."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Genellikle libks/KingStation uygulamalarını varlıkları işaret eden paketleyen geliştiriciler tarafından ayarlanır."
   )
MSG_HASH(
...
MSG_HASH( /* FIXME Should be MSG_ */
   ...
   "Grafik sürücünüz KingStation'taki mevcut video sürücüsü ile uyumlu değil ve %s sürücüsüne geri dönülüyor. Lütfen değişikliklerin geçerli olması için KingStation'ı yeniden başlatın."
   )
MSG_HASH( /* FIXME Should be MSG_ */
...
MSG_HASH(
   ...
   "KingStation ekibine tanılama bilgileri göndermek için iki kez daha basın."
   )
MSG_HASH(
   MSG_PRESS_ONE_MORE_TIME_TO_SEND_DEBUG_INFO,
   "KingStation ekibine tanılama bilgileri göndermek için bir kez daha basın."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Diğer eş KingStation çalıştırmadığı veya KingStation'ın eski bir sürümünü çalıştırdığı için bir netplay bağlantı girişimi başarısız oldu."
   )
MSG_HASH(
   MSG_NETPLAY_OUT_OF_DATE,
   "Netplay eşiniz KingStation'ın eski bir sürümünü kullanıyor. Bağlantı gerçekleştiremez."
   )
MSG_HASH(
   MSG_NETPLAY_DIFFERENT_VERSIONS,
   "UYARI: Netplay eşi farklı bir KingStation sürümünü çalıştırıyor. Sorun oluşursa, aynı sürümü kullanın."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Libks çekirdeği içerik gerektirir, hiçbir şey sağlanmadı."
   )
MSG_HASH(
   MSG_ERROR_LIBKS_CORE_REQUIRES_SPECIAL_CONTENT,
   "Libks çekirdeği özel içerik gerektirir, hiçbir şey sağlanmadı."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Oyuna Özel Seçenekler: oyunda bulunan oyuna özgü temel seçenekler"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Libks çekirdek donanımdır. Sonrası gölgeli kayıt kullanmanız gerekir."
   )
MSG_HASH(
...
MSG_HASH(
   MSG_LIBKS_ABI_BREAK,
   "bu libks uygulamasından farklı bir libks sürümüne karşı derlenmiştir."
   )
MSG_HASH(
   MSG_LIBKS_FRONTEND,
   "Libks için ön uç"
...
MSG_HASH(
   ...
   "Libks kukla çekirdeği kullanılıyor. Kayıt atlanıyor."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Çıkışlar KingStation'ı yeniden başlatır. Belirli menü ayarlarının etkinleştirilmesi için gereklidir (örneğin, menü sürücüsünü değiştirirken)."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Tarama Tamamlandı.<br><br>\nİçeriğin doğru bir şekilde taranabilmesi için şunları yapmanız gerekir:\n<ul><li>önceden indirilmiş uyumlu bir çekirdeğe sahip olmak</li>\n<li>\"Temel Bilgi Dosyaları\" nı Çevrimiçi Güncelleyici aracılığıyla güncelle</li>\n<li>\"Veritabanları\" nı Çevrimiçi Güncelleyici aracılığıyla güncelle</li>\n<li>Yukarıdakilerden biri yeni yapılmışsa KingStation'ı yeniden başlat</li></ul>\nSon olarak, içeriğin mevcut veritabanlarıyla eşleşmesi gerekir <a href=\"https://docs.libks.com/guides/roms-playlists-thumbnails/#sources\">burdan</a>. Hala çalışmıyorsa, düşünün <a href=\"https://www.github.com/libks/KingStation/issues\">hata raporu gönder</a>."
   )
#endif
