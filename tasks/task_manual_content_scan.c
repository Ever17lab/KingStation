...
static void task_manual_content_scan_free(ks_task_t *task)
{
   manual_scan_handle_t *manual_scan = NULL;
...
static void task_manual_content_scan_handler(ks_task_t *task)
{
   manual_scan_handle_t *manual_scan = NULL;
...
static bool task_manual_content_scan_finder(ks_task_t *task, void *user_data)
{
   manual_scan_handle_t *manual_scan = NULL;
