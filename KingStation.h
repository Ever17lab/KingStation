...
#ifndef __KingStation_H
#define __KingStation_H
...
#define KS_ENVIRONMENT_KingStation_START_BLOCK 0x800000

#define KS_ENVIRONMENT_SET_SAVE_STATE_IN_BACKGROUND (2 | KS_ENVIRONMENT_KingStation_START_BLOCK)
                                            /* bool * --
                                            * Boolean value that tells the front end to save states in the
                                            * background or not.
                                            */

#define KS_ENVIRONMENT_GET_CLEAR_ALL_THREAD_WAITS_CB (3 | KS_ENVIRONMENT_KingStation_START_BLOCK)
                                            /* ks_environment_t * --
...
#define KS_ENVIRONMENT_POLL_TYPE_OVERRIDE (4 | KS_ENVIRONMENT_KingStation_START_BLOCK)
                                            /* unsigned * --
                                            * Tells the frontend to override the poll type behavior. 
                                            * Allows the frontend to influence the polling behavior of the
                                            * frontend.
                                            *
                                            * Will be unset when ks_unload_game is called.
                                            *
...
enum kingsn_ctl_state
{
   KINGSN_CTL_NONE = 0,

   /* Deinitializes KingStation. */
   KINGSN_CTL_MAIN_DEINIT,

   KINGSN_CTL_IS_INITED,

   KINGSN_CTL_IS_DUMMY_CORE,
   KINGSN_CTL_IS_CORE_LOADED,

   KINGSN_CTL_IS_BPS_PREF,
   KINGSN_CTL_UNSET_BPS_PREF,

   KINGSN_CTL_IS_PATCH_BLOCKED,

   KINGSN_CTL_IS_UPS_PREF,
   KINGSN_CTL_UNSET_UPS_PREF,

   KINGSN_CTL_IS_IPS_PREF,
   KINGSN_CTL_UNSET_IPS_PREF,

#ifdef HAVE_CONFIGFILE
   /* Block config read */
   KINGSN_CTL_SET_BLOCK_CONFIG_READ,
   KINGSN_CTL_UNSET_BLOCK_CONFIG_READ,
#endif

   /* Username */
   KINGSN_CTL_HAS_SET_USERNAME,

   KINGSN_CTL_HAS_SET_SUBSYSTEMS,

   KINGSN_CTL_IS_IDLE,
   KINGSN_CTL_SET_IDLE,

   KINGSN_CTL_SET_WINDOWED_SCALE,

#ifdef HAVE_CONFIGFILE
   KINGSN_CTL_IS_OVERRIDES_ACTIVE,

   KINGSN_CTL_IS_REMAPS_CORE_ACTIVE,
   KINGSN_CTL_SET_REMAPS_CORE_ACTIVE,
   KINGSN_CTL_UNSET_REMAPS_CORE_ACTIVE,

   KINGSN_CTL_IS_REMAPS_CONTENT_DIR_ACTIVE,
   KINGSN_CTL_SET_REMAPS_CONTENT_DIR_ACTIVE,
   KINGSN_CTL_UNSET_REMAPS_CONTENT_DIR_ACTIVE,

   KINGSN_CTL_IS_REMAPS_GAME_ACTIVE,
   KINGSN_CTL_SET_REMAPS_GAME_ACTIVE,
   KINGSN_CTL_UNSET_REMAPS_GAME_ACTIVE,
#endif

   KINGSN_CTL_IS_MISSING_BIOS,
   KINGSN_CTL_SET_MISSING_BIOS,
   KINGSN_CTL_UNSET_MISSING_BIOS,

   KINGSN_CTL_IS_GAME_OPTIONS_ACTIVE,

   KINGSN_CTL_IS_PAUSED,
   KINGSN_CTL_SET_PAUSED,

   KINGSN_CTL_SET_SHUTDOWN,

   /* Runloop state */
   KINGSN_CTL_STATE_FREE,

   /* Performance counters */
   KINGSN_CTL_GET_PERFCNT,
   KINGSN_CTL_SET_PERFCNT_ENABLE,
   KINGSN_CTL_UNSET_PERFCNT_ENABLE,
   KINGSN_CTL_IS_PERFCNT_ENABLE,

   /* Core options */
   KINGSN_CTL_HAS_CORE_OPTIONS,
   KINGSN_CTL_GET_CORE_OPTION_SIZE,
   KINGSN_CTL_CORE_OPTIONS_LIST_GET,
   KINGSN_CTL_CORE_OPTION_PREV,
   KINGSN_CTL_CORE_OPTION_NEXT,
   KINGSN_CTL_CORE_IS_RUNNING,

   /* BSV Movie */
   KINGSN_CTL_BSV_MOVIE_IS_INITED
};

enum kingsn_capabilities
{
   KINGSN_CAPABILITIES_NONE = 0,
   KINGSN_CAPABILITIES_CPU,
   KINGSN_CAPABILITIES_COMPILER
};

enum kingsn_override_setting
{
   KINGSN_OVERRIDE_SETTING_NONE = 0,
   KINGSN_OVERRIDE_SETTING_LIBKS,
   KINGSN_OVERRIDE_SETTING_VERBOSITY,
   KINGSN_OVERRIDE_SETTING_LIBKS_DIRECTORY,
   KINGSN_OVERRIDE_SETTING_SAVE_PATH,
   KINGSN_OVERRIDE_SETTING_STATE_PATH,
#ifdef HAVE_NETWORKING
   KINGSN_OVERRIDE_SETTING_NETPLAY_MODE,
   KINGSN_OVERRIDE_SETTING_NETPLAY_IP_ADDRESS,
   KINGSN_OVERRIDE_SETTING_NETPLAY_IP_PORT,
   KINGSN_OVERRIDE_SETTING_NETPLAY_STATELESS_MODE,
   KINGSN_OVERRIDE_SETTING_NETPLAY_CHECK_FRAMES,
#endif
   KINGSN_OVERRIDE_SETTING_UPS_PREF,
   KINGSN_OVERRIDE_SETTING_BPS_PREF,
   KINGSN_OVERRIDE_SETTING_IPS_PREF,
   KINGSN_OVERRIDE_SETTING_LIBKS_DEVICE,
   KINGSN_OVERRIDE_SETTING_LOG_TO_FILE,
   KINGSN_OVERRIDE_SETTING_LAST
};
...
typedef struct kingsn_resolution
{
   unsigned idx;
   unsigned id;
} kingsn_resolution_t;
...
typedef struct global
{
   ...
   struct
   {
      ks_time_t prev_start_time;
      ks_time_t noop_press_time;
      ks_time_t noop_start_time;
      ks_time_t action_start_time;
      ks_time_t action_press_time;
   } menu;
#endif
   struct
   {
   ...
   struct
   {
      struct
      {
         struct
         {
            uint32_t *list;
            unsigned count;
            kingsn_resolution_t current;
            kingsn_resolution_t initial;
            bool check;
         } resolutions;
...
{
   char *pending_subsystem_roms[KINGSN_MAX_SUBSYSTEM_ROMS];
...
bool kingsn_ctl(enum kingsn_ctl_state state, void *data);

int KingStation_get_capabilities(enum kingsn_capabilities type,
      char *s, size_t len);

void KingStation_override_setting_set(enum kingsn_override_setting enum_idx, void *data);

void KingStation_override_setting_unset(enum kingsn_override_setting enum_idx, void *data);

bool KingStation_override_setting_is_set(enum kingsn_override_setting enum_idx, void *data);

bool KingStation_is_forced_fullscreen(void);

void KingStation_set_current_core_type(
      enum kingsn_core_type type, bool explicitly_set);

bool KingStation_apply_shader(enum kingsn_shader_type type, const char *preset_path,
      bool message);

const char* KingStation_get_shader_preset(void);

bool KingStation_is_switching_display_mode(void);

/**
 * KingStation_main_init:
 ...
 **/
bool KingStation_main_init(int argc, char *argv[]);

bool KingStation_main_quit(void);
 ...
 * runloop_iterate:
 *
 * Run Libks core in KingStation for one frame.
 *
...
void KingStation_menu_running(void);

void KingStation_menu_running_finished(bool quit);

kingsn_system_info_t *runloop_get_system_info(void);

struct ks_system_info *runloop_get_libks_system_info(void);

void KingStation_force_video_driver_fallback(const char *driver);

enum ks_language kingsn_get_language_from_iso(const char *lang);

void kingsn_favorites_init(void);

void kingsn_favorites_deinit(void);
...
#if defined(_XBOX360)
#define DEFAULT_SHADER_TYPE KINGSN_SHADER_HLSL
#elif defined(__PSL1GHT__) || defined(HAVE_OPENGLES2) || defined(HAVE_GLSL)
#define DEFAULT_SHADER_TYPE KINGSN_SHADER_GLSL
#elif defined(__CELLOS_LV2__) || defined(HAVE_CG)
#define DEFAULT_SHADER_TYPE KINGSN_SHADER_CG
#else
#define DEFAULT_SHADER_TYPE KINGSN_SHADER_NONE
#endif
...
typedef struct video_shader_ctx_init
{
   ...
   void *data;
   void *shader_data;
   enum kingsn_shader_type shader_type;
   struct
   {
...
typedef struct video_info
{
    ...
    *
    * The maximum resolution is a multiple of 256x256 size (KINGSN_SCALE_BASE),
    * so an input scale of 2 means you should allocate a texture or of 512x512.
    *
    * Maximum input size: KINGSN_SCALE_BASE * input_scale
    */
...
typedef struct video_poke_interface
{
   ...
   ks_proc_address_t (*get_proc_address)(void *data, const char *sym);
   ...
   bool (*get_current_software_framebuffer)(void *data,
         struct ks_framebuffer *framebuffer);
   bool (*get_hw_render_interface)(void *data,
         const struct ks_hw_render_interface **iface);
...
typedef struct video_driver
{
   ...
   bool (*set_shader)(void *data, enum kingsn_shader_type type,
         const char *path);
...
struct ks_hw_render_callback *video_driver_get_hw_context(void);
...
enum ks_pixel_format video_driver_get_pixel_format(void);
...
struct ks_system_av_info *video_viewport_get_system_av_info(void);
...
enum kingsn_display_type video_driver_display_type_get(void);

uintptr_t video_driver_window_get(void);

void video_driver_display_type_set(enum kingsn_display_type type);
...
static INLINE bool gl_set_core_context(enum ks_hw_context_type ctx_type)
{
   gfx_ctx_flags_t flags;
   if (ctx_type != KS_HW_CONTEXT_OPENGL_CORE)
      return false;
...
typedef struct camera_driver
{
   ...
   bool (*poll)(void *data,
         ks_camera_frame_raw_framebuffer_t frame_raw_cb,
         ks_camera_frame_opengl_texture_t frame_gl_cb);
...
unsigned int KingStation_get_rotation(void);

void KingStation_init_task_queue(void);
