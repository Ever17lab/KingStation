 ...
 *
 * While you *can* allocate the ks pad here, it isn't mandatory (see
 ...
 */
static void hid_null_set_rumble(void *data, enum ks_rumble_effect effect, uint16_t strength) { }
