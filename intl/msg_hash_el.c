       ...
       switch (idx)
       {
          ...
          case KINGSN_GRAB_MOUSE_TOGGLE:
             snprintf(s, len,
                   ...
                   " \n"
                   "Όταν το ποντίκι ελέγχεται, το KingStation κρύβει το \n"
          ...
          case KINGSN_GAME_FOCUS_TOGGLE:
             snprintf(s, len,
                   ...
                   " \n"
                   "Όταν ένα παιχνίδι έχει την εστίαση, το KingStation θα απενεργοποιήσει \n"
          ...
          case KINGSN_QUIT_KEY:
             snprintf(s, len,
                   "Κουμπί καθαρής εξόδου από το KingStation. \n"
                   " \n"
                   "Η απότομη απενεργοποίηση της λειτουργίας του θα \n"
                   "τερματίσει το KingStation χωρίς να αποθηκεύσει την RAM κ.α."
#ifdef __unix__
    ...
    switch (msg)
    {
        case MENU_ENUM_LABEL_ACCOUNTS_KS_ACHIEVEMENTS:
            snprintf(s, len, "Στοιχεία σύνδεσης για τον \n"
                    ...
                    " \n"
                    "Επισκεφθείτε το ksachievements.org και εγγραφείτε \n"
        ...
        case MENU_ENUM_LABEL_SORT_SAVESTATES_ENABLE:
            snprintf(s, len, "Οργάνωση καταστάσεων αποθήκευσης σε φακέλους \n"
                    "ονομασμένες με βάση τον πυρήνα libks που χρησιμοποιούν.");
            break;
        case MENU_ENUM_LABEL_SORT_SAVEFILES_ENABLE:
            snprintf(s, len, "Οργάνωση αρχείων αποθήκευσης σε φακέλους \n"
                    "ονομασμένα με βάση τον πυρήνα libks που χρησιμοποιούν.");
            break;
        ...
        case MENU_ENUM_LABEL_LIBKS_INFO_PATH:
            snprintf(s, len,
                     "Ευρετήριο Πληροφοριών Πυρήνων. \n"
                             ...
                             "για πληφοροφίες των πυρήνων libks.");
            break;
