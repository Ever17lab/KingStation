...
MSG_HASH(
   ...
   "在经典游戏中赢得成就。更多信息，请访问 https://ksachievements.org"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "通常由 Libks/KingStation 的打包开发者设置，指向素材文件夹。"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "扫描完成。<br><br>\n为了是游戏被正确扫描，您必须：\n<ul><li>已下载了兼容的核心</li>\n<li>已更新了「核心信息文件」</li>\n<li>已更新了「Databases」</li>\n<li>更新后重启全能模拟器</li></ul>\n最后，游戏 ROM 必须匹配<a href=\"https://docs.libks.com/guides/roms-playlists-thumbnails/#sources\">数据库</a>。如果仍然不行，<a href=\"https://www.github.com/libks/KingStation/issues\">请报告 BUG</a>。"
   )
#endif
