 ...
 *
 *  KingStation is free software: you can redistribute it and/or modify it under the terms *  of the GNU General Public License as published by the Free Software Found-
      ...
      )
{
   ...
   if (new_strength != *last_strength)
   {
      ...
      CALL_VOID_METHOD_PARAM(env, g_android->activity->clazz,
            g_android->doVibrate, (jint)id, (jint)KS_RUMBLE_STRONG, (jint)strength_final, (jint)0);
