            ...
            switch (id)
            {
               ...
               case KS_DEVICE_ID_MOUSE_LEFT:
                  return gx->mouse[joy_idx].button & 
                     (1 << KS_DEVICE_ID_MOUSE_LEFT);
               case KS_DEVICE_ID_MOUSE_RIGHT:
                  return gx->mouse[joy_idx].button & 
                     (1 << KS_DEVICE_ID_MOUSE_RIGHT);
               default:
                  break;
            }
         }
                        ...
                        &res_x, &res_y, &res_screen_x, &res_screen_y))
            {
               switch (id)
               {
                  ...
                  case KS_DEVICE_ID_LIGHTGUN_TRIGGER:
                     return gx->mouse[joy_idx].button & 
                        (1 << KS_DEVICE_ID_LIGHTGUN_TRIGGER);
                  case KS_DEVICE_ID_LIGHTGUN_AUX_A:
                     return gx->mouse[joy_idx].button & 
                        (1 << KS_DEVICE_ID_LIGHTGUN_AUX_A);
                  case KS_DEVICE_ID_LIGHTGUN_AUX_B:
                     return gx->mouse[joy_idx].button & 
                        (1 << KS_DEVICE_ID_LIGHTGUN_AUX_B);
                  case KS_DEVICE_ID_LIGHTGUN_AUX_C:
                     return gx->mouse[joy_idx].button & 
                        (1 << KS_DEVICE_ID_LIGHTGUN_AUX_C);
                  case KS_DEVICE_ID_LIGHTGUN_START:
                     return gx->mouse[joy_idx].button & 
                        (1 << KS_DEVICE_ID_LIGHTGUN_START);
                  case KS_DEVICE_ID_LIGHTGUN_SELECT:
                     return gx->mouse[joy_idx].button & 
                        (1 << KS_DEVICE_ID_LIGHTGUN_SELECT);
