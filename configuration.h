...
#ifndef __KINGSN_CONFIGURATION_H__
#define __KINGSN_CONFIGURATION_H__
...
typedef struct settings
{
   ...
   struct
   {
      ...
      unsigned input_libks_device[MAX_USERS];
      unsigned input_analog_dpad_mode[MAX_USERS];

      unsigned input_keymapper_ids[MAX_USERS][KINGSN_CUSTOM_BIND_LIST_END];

      unsigned input_remap_ids[MAX_USERS][KINGSN_CUSTOM_BIND_LIST_END];
   ...
   struct
   {
      ...
      char path_libks_info[PATH_MAX_LENGTH];
      ...
      char directory_libks[PATH_MAX_LENGTH];
   ...
   struct
   {
      ...
      bool menu_show_help;
      bool menu_show_quit_KingStation;
      bool menu_show_restart_KingStation;
