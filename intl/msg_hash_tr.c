...
int msg_hash_get_help_tr_enum(enum msg_hash_enums msg, char *s, size_t len)
{
    ...
    switch (msg)
    {
        ...
        case MENU_ENUM_LABEL_SORT_SAVESTATES_ENABLE:
            snprintf(s, len, "Kullanılan libks coreundan sonra \n"
                    "adlandırılmış klasörlerdeki kaydetme durumlarını sıralayın.");
            break;
        case MENU_ENUM_LABEL_SORT_SAVEFILES_ENABLE:
            snprintf(s, len, "Sıralama kullanılan libks \n"
        ...
        case MENU_ENUM_LABEL_LIBKS_INFO_PATH:
            snprintf(s, len,
                     "Çekirdek Bilgi Dizini. \n"
                             " \n"
                             "Libks Çekirdek bilgisini nerede \n"
        ...
        case MENU_ENUM_LABEL_LOAD_CONTENT_HISTORY:
            snprintf(s, len,
                     "Geçmişten içerik yükleniyor. \n"
                             " \n"
                             "İçerik yüklendikçe, içerik ve libks \n"
        ...
        case MENU_ENUM_LABEL_VIDEO_DRIVER:
            {
               ...
               if (string_is_equal(video_driver, "gl"))
               {
                  snprintf(s, len,
                        ...
                        "Çekirdek uygulamalarına ek olarak libks GL \n"
                        "çekirdeklerinin kullanılmasına izin verir.\n"
                        " \n"
                        "Yazılım tarafından oluşturulan ve libks GL \n"
               ...
               else if (string_is_equal(video_driver, "sdl2"))
               {
                  snprintf(s, len,
                        ...
                        "video sürücüsüdür.\n"
                        " \n"
                        "Yazılım tarafından oluşturulan libks Çekirdek uygulamaları \n"
    ...
    case MENU_ENUM_LABEL_CRT_SWITCH_RESOLUTION_SUPER: snprintf(s, len, "SUPER CRT OLARAK BELIRLE");
      break;
        ...
        case MENU_ENUM_LABEL_INPUT_BIND_DEVICE_TYPE:
            snprintf(s, len,
                     "Giriş Cihazı Tipi. \n"
                             ...
                             "libks core'unun kendisi ile ilgilidir. "
            );
            break;
        case MENU_ENUM_LABEL_LIBKS_LOG_LEVEL:
            snprintf(s, len,
                     "Libks Core'u için günlük seviyesini ayarlar \n"
                             "(GET_LOG_INTERFACE). \n"
                             " \n"
                             " Libks core'u tarafından \n"
                             " verilen günlük seviyesi libks_log \n"
        ...
        case MENU_ENUM_LABEL_ENABLE_HOTKEY:
            snprintf(s, len,
                     "Diğer kısayol tuşlarını etkinleştirin.\n"
                             ...
                             "KS_KEYBOARDmerkezli uygulamalar için \n"
                             "kullanışlıdır.");
            break;
        ...
        case MENU_ENUM_LABEL_LIBKS_DIR_PATH:
            snprintf(s, len,
                     "Çekirdek Dizini. \n"
                             " \n"
                             "Libks Çekirdek uygulamalarının \n"
                             "aranacağı dizin. ");
            break;
        ...
        case MENU_ENUM_LABEL_VIDEO_ROTATION:
            snprintf(s, len,
                     "Ekranın belirli bir dönüşünü \n"
                             "zorlar.\n"
                             " \n"
                             "Dönme, libks çekirdeğinin ayarladığı\n"
      ...
      case MENU_ENUM_LABEL_VIDEO_CTX_SCALING:
        ...
        case MENU_ENUM_LABEL_CORE_UPDATER_BUILDBOT_URL:
            snprintf(s, len,
                     "Libks buildbotundaki çekirdek \n"
                             "güncelleyici dizininin URL'si.");
            break;
        case MENU_ENUM_LABEL_BUILDBOT_ASSETS_URL:
            snprintf(s, len,
                     "Libks buildbot'taki içerikler \n"
                             "dizinindeki URL.");
            break;
        ...
        case MENU_ENUM_LABEL_VALUE_WHAT_IS_A_CORE_DESC:
            snprintf(s, len,
                     "KingStation kendi başına hiçbir şey yapmaz. \n"
                            ...
                            "\n"
                            "Böylelikle programa 'Libks Çekirdek', \n"
