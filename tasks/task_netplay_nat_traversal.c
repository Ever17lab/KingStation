...
static void netplay_nat_traversal_callback(ks_task_t *task,
      void *task_data,
      void *user_data, const char *error)
{
   ...
   netplay_driver_ctl(KINGSN_NETPLAY_CTL_FINISHED_NAT_TRAVERSAL, NULL);
}

static void task_netplay_nat_traversal_handler(ks_task_t *task)
{
   struct nat_traversal_state_data *ntsd =
