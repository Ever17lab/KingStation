...
enum kingsn_menu_ctl_state
{
   KINGSN_MENU_CTL_NONE = 0,
   KINGSN_MENU_CTL_SET_PENDING_QUICK_MENU,
   KINGSN_MENU_CTL_DEINIT,
   KINGSN_MENU_CTL_SET_PREVENT_POPULATE,
   KINGSN_MENU_CTL_UNSET_PREVENT_POPULATE,
   KINGSN_MENU_CTL_IS_PREVENT_POPULATE,
   KINGSN_MENU_CTL_FIND_DRIVER,
   KINGSN_MENU_CTL_ENVIRONMENT,
   KINGSN_MENU_CTL_POINTER_DOWN,
   KINGSN_MENU_CTL_POINTER_UP,
   KINGSN_MENU_CTL_OSK_PTR_AT_POS,
   KINGSN_MENU_CTL_BIND_INIT,
   KINGSN_MENU_CTL_UPDATE_THUMBNAIL_PATH,
   KINGSN_MENU_CTL_UPDATE_THUMBNAIL_IMAGE,
   KINGSN_MENU_CTL_REFRESH_THUMBNAIL_IMAGE,
