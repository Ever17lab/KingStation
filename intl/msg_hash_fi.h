...
MSG_HASH(
   ...
   "Dynaaminen libks-kirjaston suorituksenaikainen lataus"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "URL ydin päivittimen hakemistoon libks buildbotissa."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "URL resurssien päivittimen hakemistoon libks buildbotissa."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Libks-ydin vaatii sisältöä, mutta mitään ei annettu."
   )
MSG_HASH(
   MSG_ERROR_LIBKS_CORE_REQUIRES_SPECIAL_CONTENT,
   "Libks-ydin vaatii erikoissisältöä, mutta mitään ei annettu."
   )
MSG_HASH(
