...
static void task_pl_manager_free(ks_task_t *task)
{
   pl_manager_handle_t *pl_manager = NULL;
...
static void task_pl_manager_reset_cores_handler(ks_task_t *task)
{
   pl_manager_handle_t *pl_manager = NULL;
...
static void task_pl_manager_clean_playlist_handler(ks_task_t *task)
{
   pl_manager_handle_t *pl_manager = NULL;
