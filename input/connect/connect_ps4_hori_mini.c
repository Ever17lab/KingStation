      ...
      uint8_t *packet, uint16_t size)
{
   ...
   {
      case 0:
         device->buttons |= (1 << KS_DEVICE_ID_JOYPAD_UP);
         break;
      case 1:
         device->buttons |= (1 << KS_DEVICE_ID_JOYPAD_UP);
         device->buttons |= (1 << KS_DEVICE_ID_JOYPAD_RIGHT);
         break;
      case 2:
         device->buttons |= (1 << KS_DEVICE_ID_JOYPAD_RIGHT);
         break;
      case 3:
         device->buttons |= (1 << KS_DEVICE_ID_JOYPAD_RIGHT);
         device->buttons |= (1 << KS_DEVICE_ID_JOYPAD_DOWN);
         break;
      case 4:
         device->buttons |= (1 << KS_DEVICE_ID_JOYPAD_DOWN);
         break;
      case 5:
         device->buttons |= (1 << KS_DEVICE_ID_JOYPAD_DOWN);
         device->buttons |= (1 << KS_DEVICE_ID_JOYPAD_LEFT);
         break;
      case 6:
         device->buttons |= (1 << KS_DEVICE_ID_JOYPAD_LEFT);
         break;
