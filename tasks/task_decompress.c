...
static void task_decompress_handler_finished(ks_task_t *task,
...
static void task_decompress_handler(ks_task_t *task)
{
   int ret;
   bool retdec                              = false;
...
static void task_decompress_handler_target_file(ks_task_t *task)
{
   bool retdec;
   int ret;
   decompress_state_t *dec                  = (decompress_state_t*)
...
static void task_decompress_handler_subdir(ks_task_t *task)
{
   int ret;
   bool retdec;
