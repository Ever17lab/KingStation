...
#include "../libks-common/compat/compat_snprintf.c"
#endif
...
#include "../libks-common/compat/compat_fnmatch.c"
#include "../libks-common/compat/fopen_utf8.c"
#include "../libks-common/memmap/memalign.c"
...
ARCHIVE FILE
============================================================ */
#include "../libks-common/file/archive_file.c"

#ifdef HAVE_ZLIB
#include "../libks-common/file/archive_file_zlib.c"
#endif

#ifdef HAVE_7ZIP
#include "../libks-common/file/archive_file_7z.c"
#endif

/*============================================================
COMPRESSION
============================================================ */
#include "../libks-common/streams/stdin_stream.c"
#include "../libks-common/streams/trans_stream.c"
#include "../libks-common/streams/trans_stream_pipe.c"

#ifdef HAVE_ZLIB
#include "../libks-common/streams/trans_stream_zlib.c"
#include "../libks-common/streams/rzip_stream.c"
#endif

/*============================================================
ENCODINGS
============================================================ */
#include "../libks-common/encodings/encoding_utf.c"
#include "../libks-common/encodings/encoding_crc32.c"
#include "../libks-common/encodings/encoding_base64.c"

/*============================================================
PERFORMANCE
============================================================ */
#include "../libks-common/features/features_cpu.c"

/*============================================================
CONFIG FILE
============================================================ */
#if defined(_MSC_VER)
#undef __LIBKS_SDK_COMPAT_POSIX_STRING_H
#undef __LIBKS_SDK_COMPAT_MSVC_H
#undef strcasecmp
#endif

#ifdef HAVE_CONFIGFILE
#include "../libks-common/file/config_file.c"
#include "../libks-common/file/config_file_userdata.c"
#endif
...
#include "../libks-common/net/net_http.c"
#endif

#include "../libks-common/formats/cdfs/cdfs.c"
...
MD5
============================================================ */
#include "../libks-common/utils/md5.c"
...
#endif
#include "../libks-common/hash/lrc_hash.c"
...
#include "../cores/libks-ffmpeg/ffmpeg_fft.c"
#endif
#endif
...
#include "../libks-common/vulkan/vulkan_symbol_wrapper.c"
...
#include "../libks-common/formats/image_texture.c"

#ifdef HAVE_RTGA
#include "../libks-common/formats/tga/rtga.c"
#endif

#ifdef HAVE_IMAGEVIEWER
#include "../cores/libks-imageviewer/image_core.c"
#endif

#include "../libks-common/formats/image_transfer.c"
#ifdef HAVE_RPNG
#include "../libks-common/formats/png/rpng.c"
#include "../libks-common/formats/png/rpng_encode.c"
#endif
#ifdef HAVE_RJPEG
#include "../libks-common/formats/jpeg/rjpeg.c"
#endif
#ifdef HAVE_RBMP
#include "../libks-common/formats/bmp/rbmp.c"
#endif

#include "../libks-common/formats/bmp/rbmp_encode.c"
#ifdef HAVE_RWAV
#include "../libks-common/formats/wav/rwav.c"
#endif
...
#include "../libks-common/gfx/gl_capabilities.c"

#ifndef HAVE_PSGL
#include "../libks-common/glsym/rglgen.c"
#if defined(HAVE_OPENGLES2)
#include "../libks-common/glsym/glsym_es2.c"
#elif defined(HAVE_OPENGLES3)
#include "../libks-common/glsym/glsym_es3.c"
#else
#include "../libks-common/glsym/glsym_gl.c"
#endif
#endif
...
#include "../input/connect/connect_ksde.c"
...
FIFO BUFFER
============================================================ */
#include "../libks-common/queues/fifo_queue.c"

/*============================================================
AUDIO RESAMPLER
============================================================ */
#include "../libks-common/audio/resampler/audio_resampler.c"
#include "../libks-common/audio/resampler/drivers/sinc_resampler.c"
#ifdef HAVE_NEAREST_RESAMPLER
#include "../libks-common/audio/resampler/drivers/nearest_resampler.c"
#endif
...
#include "../cores/libks-video-processor/video_processor_v4l2.c"
#endif
...
#ifdef HAVE_AUDIOMIXER
#include "../libks-common/audio/audio_mixer.c"
#endif

/*============================================================
SCALERS
============================================================ */
#include "../libks-common/gfx/scaler/scaler_filter.c"
#include "../libks-common/gfx/scaler/pixconv.c"
#include "../libks-common/gfx/scaler/scaler.c"
#include "../libks-common/gfx/scaler/scaler_int.c"
...
#include "../libks-common/audio/dsp_filters/echo.c"
#include "../libks-common/audio/dsp_filters/eq.c"
#include "../libks-common/audio/dsp_filters/chorus.c"
#include "../libks-common/audio/dsp_filters/iir.c"
#include "../libks-common/audio/dsp_filters/panning.c"
#include "../libks-common/audio/dsp_filters/phaser.c"
#include "../libks-common/audio/dsp_filters/reverb.c"
#include "../libks-common/audio/dsp_filters/wahwah.c"
#endif
#endif
...
DYNAMIC
============================================================ */
#include "../libks-common/dynamic/dylib.c"
#ifdef HAVE_VIDEO_FILTER
#include "../gfx/video_filter.c"
#endif
#ifdef HAVE_DSP_FILTER
#include "../libks-common/audio/dsp_filter.c"
#endif
...
============================================================ */
#ifdef HAVE_FFMPEG
#include "../cores/libks-ffmpeg/ffmpeg_core.c"
#endif

#if defined(HAVE_MPV)
#if defined(HAVE_OPENGL) || defined(HAVE_OPENGLES)
#include "../cores/libks-mpv/mpv-libks.c"
#endif
#endif
...
FILE
============================================================ */
#include "../libks-common/file/file_path.c"
#include "../libks-common/file/file_path_io.c"
#include "../file_path_special.c"
#include "../libks-common/lists/dir_list.c"
#include "../libks-common/lists/string_list.c"
#include "../libks-common/lists/file_list.c"
#include "../libks-common/file/ks_dirent.c"
#include "../libks-common/streams/file_stream.c"
#include "../libks-common/streams/file_stream_transforms.c"
#include "../libks-common/streams/interface_stream.c"
#include "../libks-common/streams/memory_stream.c"
#ifndef __WINRT__
#include "../libks-common/vfs/vfs_implementation.c"
#endif

#ifdef HAVE_CDROM
#include "../libks-common/cdrom/cdrom.c"
#include "../libks-common/vfs/vfs_implementation_cdrom.c"
#include "../libks-common/media/media_detect_cd.c"
#endif

#include "../libks-common/string/stdstring.c"
#include "../libks-common/file/nbio/nbio_stdio.c"
#if defined(__linux__)
#include "../libks-common/file/nbio/nbio_linux.c"
#endif
#if defined(HAVE_MMAP) && defined(BSD)
#include "../libks-common/file/nbio/nbio_unixmmap.c"
#endif
#if defined(HAVE_MMAP_WIN32)
#include "../libks-common/file/nbio/nbio_windowsmmap.c"
#endif
#if defined(ORBIS)
#include "../libks-common/file/nbio/nbio_orbis.c"
#endif
#include "../libks-common/file/nbio/nbio_intf.c"

/*============================================================
MESSAGE
============================================================ */
#include "../libks-common/queues/message_queue.c"
...
KingStation
============================================================ */
#include "../KingStation.c"
#include "../libks-common/queues/task_queue.c"
...
#include "../libks-common/rthreads/rthreads.c"
#include "../gfx/video_thread_wrapper.c"
#include "../audio/audio_thread_wrapper.c"
#endif

/* needed for playlists, netplay lobbies and achievements */
#include "../libks-common/formats/json/rjson.c"
...
#include "../libks-common/net/net_compat.c"
#include "../libks-common/net/net_socket.c"
#include "../libks-common/net/net_http.c"
#include "../libks-common/net/net_natt.c"
#if !defined(HAVE_SOCKET_LEGACY)
#include "../libks-common/net/net_ifinfo.c"
#endif
...
#include "../gfx/widgets/gfx_widget_libks_message.c"
...
#include "../cores/libks-net-kspad/net_kspad_core.c"
#endif

#if defined(HAVE_NETWORKING)
#include "../libks-common/net/net_http_parse.c"
#endif
...
#ifdef HAVE_CHD
#include "../libks-common/formats/libchdr/libchdr_zlib.c"
#include "../libks-common/formats/libchdr/libchdr_bitstream.c"
#include "../libks-common/formats/libchdr/libchdr_cdrom.c"
#include "../libks-common/formats/libchdr/libchdr_chd.c"

#ifdef HAVE_FLAC
#include "../libks-common/formats/libchdr/libchdr_flac.c"
#include "../libks-common/formats/libchdr/libchdr_flac_codec.c"
#endif

#ifdef HAVE_7ZIP
#include "../libks-common/formats/libchdr/libchdr_lzma.c"
#endif

#include "../libks-common/formats/libchdr/libchdr_huffman.c"

#include "../libks-common/streams/chd_stream.c"
#endif
#endif
...
XML
============================================================ */
#include "../libks-common/formats/xml/rxml.c"
#include "../libks-common/formats/logiqx_dat/logiqx_dat.c"
#include "../deps/yxml/yxml.c"

/*============================================================
 AUDIO UTILS
============================================================ */
#include "../libks-common/audio/conversion/s16_to_float.c"
#include "../libks-common/audio/conversion/float_to_s16.c"
#ifdef HAVE_AUDIOMIXER
#include "../libks-common/audio/audio_mix.c"
#endif
...
============================================================ */
#ifdef HAVE_LIBKSDB
#include "../libks-db/bintree.c"
#include "../libks-db/libksdb.c"
#include "../libks-db/rmsgpack.c"
#include "../libks-db/rmsgpack_dom.c"
#include "../libks-db/query.c"
...
#include "../libks-common/net/net_socket_ssl_mbed.c"
#endif
#endif
#endif

#ifdef HAVE_GONG
#include "../cores/libks-gong/gong.c"
#endif

/*============================================================
PLAYLIST NAME SANITIZATION
============================================================ */
#include "../libks-common/playlists/label_sanitization.c"
...
MISC FILE FORMATS
============================================================ */
#include "../libks-common/formats/m3u/m3u_file.c"

/*============================================================
TIME
============================================================ */
#include "../libks-common/time/rtime.c"
