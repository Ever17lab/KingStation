...
# this time, this script is called by libks-super.  Revisit the whole
# issue at some point.
...
# Inserted here is libks-super's script-modules/fetch-rules.sh, with a
...
fetch_git "https://github.com/libks/common-shaders.git" "media/shaders_cg"
fetch_git "https://github.com/libks/common-overlays.git" "media/overlays"
fetch_git "https://github.com/libks/KingStation-assets.git" "media/assets"
fetch_git "https://github.com/libks/KingStation-joypad-autoconfig.git" "media/autoconfig"
fetch_git "https://github.com/libks/libks-database.git" "media/libksdb"
