...
void MainWindow::onPlaylistThumbnailDownloadCanceled()
{
   ...
   KINGSN_LOG("[Qt]: Playlist thumbnail download was canceled.\n");
}
...
void MainWindow::onPlaylistThumbnailDownloadFinished()
{
   ...
   if (code != 200)
   {
      ...
      if (!redirectUrl.isEmpty())
      {
         ...
         KINGSN_LOG("[Qt]: Thumbnail download got redirect with"
   ...
   {
      KINGSN_LOG("[Qt]: Playlist thumbnails finished downloading.\n");
      /* update thumbnail */
      emit itemChanged();
   }
