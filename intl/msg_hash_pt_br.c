    ...
    switch (msg)
    {
        case MENU_ENUM_LABEL_ACCOUNTS_KS_ACHIEVEMENTS:
            snprintf(s, len, "Detalhes de acesso para \n"
                    ...
                    " \n"
                    "Visite ksachievements.org e inscreva-se \n"
        ...
        case MENU_ENUM_LABEL_SORT_SAVESTATES_ENABLE:
            snprintf(s, len, "Ordenar jogos salvos em pastas \n"
                    "com o nome do núcleo Libks utilizado.");
            break;
        ...
        case MENU_ENUM_LABEL_LIBKS_INFO_PATH:
            snprintf(s, len,
                     "Diretório de informações de núcleos. \n"
                             ...
                             "informação sobre os núcleos Libks.");
            break;
        ...
        case MENU_ENUM_LABEL_CORE_LIST:
            snprintf(s, len,
                     "Carregar núcleo. \n"
                             ...
                             "Libks. Aonde o navegador de arquivos \n"
        ...
        case MENU_ENUM_LABEL_LOAD_CONTENT_HISTORY:
            snprintf(s, len,
                     "Carregando conteúdo do histórico. \n"
                             ...
                             "Libks e conteúdo são salvas no histórico. \n"
                             " \n"
        ...
        case MENU_ENUM_LABEL_VIDEO_DRIVER:
            {
               ...
               else if (string_is_equal(video_driver, "sdl2"))
               {
                  snprintf(s, len,
                        ...
                        "libks renderizados por software é dependente \n"
        ...
        case MENU_ENUM_LABEL_INPUT_BIND_DEVICE_TYPE:
            snprintf(s, len,
                     "Tipo de dispositivo de entrada. \n"
                             ...
                             "Isto é relevante para o núcleo Libks."
            );
            break;
        case MENU_ENUM_LABEL_LIBKS_LOG_LEVEL:
            snprintf(s, len,
                     "Define o nível de registro de eventos dos \n"
                             ...
                             " pelo núcleo Libks for abaixo do nível \n"
                             " libks_log, ele é ignorado.\n"
                             " \n"
        ...
        case MENU_ENUM_LABEL_ENABLE_HOTKEY:
            snprintf(s, len,
                     "Habilitar outras teclas de atalho. \n"
                             ...
                             "KS_KEYBOARD que consultam uma grande \n"
        ...
        case MENU_ENUM_LABEL_LIBKS_DIR_PATH:
            snprintf(s, len,
                     "Diretório de núcleo. \n"
                             ...
                             "implementações de núcleo Libks.");
            break;
        ...
        case MENU_ENUM_LABEL_VIDEO_ROTATION:
            snprintf(s, len,
                     "Forçar uma rotação específica \n"
                             ...
                             "núcleo Libks define (consulte Permitir \n"
                             "Rotação).");
            break;
        ...
        case MENU_ENUM_LABEL_BUILDBOT_ASSETS_URL:
            snprintf(s, len,
                     "URL para o diretório de atualizações \n"
                             "de recursos no buildbot do Libks.");
            break;
        ...
        case MENU_ENUM_LABEL_VALUE_WHAT_IS_A_CORE_DESC:
            snprintf(s, len,
                     "O KingStation sozinho não faz nada. \n"
                            ...
                            "'Núcleo Libks', ou 'núcleo' para encurtar. \n"
                            " \n"
