        ...
        msg >= MENU_ENUM_LABEL_INPUT_HOTKEY_BIND_BEGIN)
    {
       ...
       switch (idx)
       {
          ...
          case KINGSN_SEND_DEBUG_INFO:
             snprintf(s, len,
                   "Envoie des informations de diagnostic sur votre appareil et la configuration de KingStation à nos serveurs pour analyse.");
             break;
          ...
          case KINGSN_GRAB_MOUSE_TOGGLE:
             snprintf(s, len,
                   ...
                   " \n"
                   "Lorsque la souris est capturée, KingStation la masque \n"
          ...
          case KINGSN_GAME_FOCUS_TOGGLE:
             snprintf(s, len,
                   ...
                   " \n"
                   "Quand un jeu est au premier plan, KingStation désactive les raccourcis \n"
          ...
          case KINGSN_QUIT_KEY:
             snprintf(s, len,
                   "Touche pour quitter KingStation proprement. \n"
                   " \n"
                   "Le fermer de manière dure (SIGKILL, etc.) quittera \n"
                   "KingStation sans sauvegarder la RAM, etc."
#ifdef __unix__
    ...
    switch (msg)
    {
        ...
        case MENU_ENUM_LABEL_SORT_SAVESTATES_ENABLE:
            snprintf(s, len, "Classe les sauvegardes instantanées dans des dossiers \n"
                    "nommés d'après le cœur libks utilisé.");
            break;
        ...
        case MENU_ENUM_LABEL_LIBKS_INFO_PATH:
            snprintf(s, len,
                     "Dossier des informations de cœurs. \n"
                             ...
                             "les informations de cœurs de libks.");
            break;
        ...
        case MENU_ENUM_LABEL_FILE_BROWSER_CORE:
            snprintf(s, len,
                     "Cœur libks. \n"
                             " \n"
                             "Sélectionnez ce fichier pour que KingStation charge ce cœur.");
            break;
        ...
        case MENU_ENUM_LABEL_CACHE_DIRECTORY:
            snprintf(s, len,
                     "Dossier de cache. \n"
                             " \n"
                             "Le contenu décompressé par KingStation \n"
                             "sera extrait temporairement dans ce dossier.");
            break;
        case MENU_ENUM_LABEL_HISTORY_LIST_ENABLE:
            snprintf(s, len,
                     "Si activé, le contenu chargé dans KingStation \n"
        ...
        case MENU_ENUM_LABEL_INPUT_POLL_TYPE_BEHAVIOR:
            snprintf(s, len,
                     "Influence la façon dont la détection\n"
                             "des touches pressées est effectuée dans KingStation.\n"
                             "\n"
        ...
        case MENU_ENUM_LABEL_CORE_LIST:
            snprintf(s, len,
                     "Charger un cœur. \n"
                             " \n"
                             "Recherchez une implémentation de cœur libks. \n"
        ...
        case MENU_ENUM_LABEL_VALUE_HELP_AUDIO_VIDEO_TROUBLESHOOTING_DESC: {
            ...
            char u[501];
            const char *t =
                    "KingStation repose sur une forme unique\n"
        ...
        case MENU_ENUM_LABEL_LOAD_CONTENT_HISTORY:
            snprintf(s, len,
                     "Charger du contenu depuis l'historique. \n"
                             ...
                             "et de cœur libks sont enregistrées dans l'historique. \n"
                             " \n"
                             "L'historique est enregistré dans un fichier dans le même \n"
                             "dossier que le fichier de configuration de KingStation. Si \n"
        ...
        case MENU_ENUM_LABEL_VIDEO_DRIVER:
            {
               ...
               if (string_is_equal(video_driver, "gl"))
               {
                  snprintf(s, len,
                        ...
                        "libks GL en plus des implémentations \n"
                        "en mode logiciel.\n"
                        " \n"
                        "Les performances pour les implémentations \n"
                        "logicielles et les cœurs libks GL \n"
               ...
               else if (string_is_equal(video_driver, "sdl2"))
               {
                  snprintf(s, len,
                        ...
                        " \n"
                        "Les performances pour les implémentations \n"
                        "de cœurs libks en mode logiciel dépendent \n"
        ...
        case MENU_ENUM_LABEL_VIDEO_SHADER_NUM_PASSES:
            snprintf(s, len,
                     "Passages de shaders. \n"
                             " \n"
                             "KingStation vous permet de mélanger et de faire correspondre \n"
        ...
        case MENU_ENUM_LABEL_INPUT_BIND_DEVICE_TYPE:
            snprintf(s, len,
                     "Type de périphérique d'entrée. \n"
                             ...
                             "est utilisée pour le cœur libks lui-même."
            );
            break;
        case MENU_ENUM_LABEL_LIBKS_LOG_LEVEL:
            snprintf(s, len,
                     "Définit le niveau de journalisation pour les cœurs libks \n"
                             "(GET_LOG_INTERFACE). \n"
                             " \n"
                             " Si un niveau de journal émis par un cœur libks \n"
                             " est inférieur au niveau libks_log, \n"
                             " il sera ignoré.\n"
                             " \n"
        ...
        case MENU_ENUM_LABEL_SHADER_APPLY_CHANGES:
            snprintf(s, len,
                     "Applique les changements de shaders.\n"
                             ...
                             "Le fichier persiste après la sortie de KingStation,\n"
        ...
        case MENU_ENUM_LABEL_GAME_FOCUS_TOGGLE:
            snprintf(s, len,
                     "Jeu au premier plan/en arrière-plan.\n"
                             " \n"
                             "Quand un jeu est en premier plan, KingStation désactive les raccourcis clavier \n"
        ...
        case MENU_ENUM_LABEL_ENABLE_HOTKEY:
            snprintf(s, len,
                     "Active d'autres touches de raccourcis.\n"
                             ...
                             "centrées KS_KEYBOARD qui utilisent une grande \n"
        ...
        case MENU_ENUM_LABEL_VIDEO_ROTATION:
            snprintf(s, len,
                     "Force une certaine rotation \n"
                             ...
                             "définies par le cœur libks (voir\n"
        ...
        case MENU_ENUM_LABEL_FASTFORWARD_RATIO:
            snprintf(s, len,
                     "Vitesse de l'avance rapide.\n"
                             ...
                             " \n"
                             "KingStation se ralentira pour veiller à \n"
        ...
        case MENU_ENUM_LABEL_VIDEO_MONITOR_INDEX:
            snprintf(s, len,
                     "Quel moniteur préférer.\n"
                             ...
                             "suggère à KingStation d'utiliser ce moniteur \n"
                             "en particulier.");
            break;
        ...
        case MENU_ENUM_LABEL_SAVESTATE_AUTO_LOAD:
            snprintf(s, len,
                     "Enregistre automatiquement une sauvegarde instantanée \n"
                             "à la fin de l'éxécution' de KingStation.\n"
                             " \n"
                             "KingStation chargera automatiquement les sauvegardes instantanées\n"
      ...
      case MENU_ENUM_LABEL_VIDEO_CTX_SCALING:
        ...
        case MENU_ENUM_LABEL_NETPLAY_NICKNAME:
            snprintf(s, len,
                     "Nom d'utilisateur de la personne utilisant KingStation. \n"
        ...
        case MENU_ENUM_LABEL_EXIT_EMULATOR:
            snprintf(s, len,
                     "Touche pour quitter KingStation proprement."
                            ...
                            "(SIGKILL, etc.) quittera KingStation\n"
        ...
        case MENU_ENUM_LABEL_VALUE_WHAT_IS_A_CORE_DESC:
            snprintf(s, len,
                     "KingStation par lui-même ne fait rien. \n"
                            " \n"
                            "Pour le faire faire des choses, vous devez y charger \n"
                            "un programme. \n"
                            "\n"
                            "Nous appelons un tel programme 'cœur Libks', \n"
                            "ou 'cœur' en bref. \n"
                            " \n"
