...
#ifndef HAVE_THREADS
static bool ctr_tasks_finder(ks_task_t *task,void *userdata)
{
   return task;
}
      ...
      input_driver_t** input, void** input_data)
{
   ...
   ctr->texture_width = video->input_scale * KINGSN_SCALE_BASE;
   ctr->texture_height = video->input_scale * KINGSN_SCALE_BASE;
   ctr->texture_linear =
