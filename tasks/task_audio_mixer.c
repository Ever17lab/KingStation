...
static void task_audio_mixer_load_free(ks_task_t *task)
{
...
static void task_audio_mixer_handle_upload_ogg(ks_task_t *task,
      void *task_data,
...
static void task_audio_mixer_handle_upload_ogg_and_play(ks_task_t *task,
      void *task_data,
      void *user_data, const char *err)
{
   audio_mixer_stream_params_t params;
...
static void task_audio_mixer_handle_upload_flac(ks_task_t *task,
      void *task_data,
      void *user_data, const char *err)
{
   audio_mixer_stream_params_t params;
...
static void task_audio_mixer_handle_upload_flac_and_play(ks_task_t *task,
      void *task_data,
      void *user_data, const char *err)
{
   audio_mixer_stream_params_t params;
...
static void task_audio_mixer_handle_upload_mp3(ks_task_t *task,
      void *task_data,
      void *user_data, const char *err)
{
   audio_mixer_stream_params_t params;
...
static void task_audio_mixer_handle_upload_mp3_and_play(ks_task_t *task,
      void *task_data,
      void *user_data, const char *err)
{
   audio_mixer_stream_params_t params;
...
static void task_audio_mixer_handle_upload_mod(ks_task_t *task,
      void *task_data,
      void *user_data, const char *err)
{
   audio_mixer_stream_params_t params;
...
static void task_audio_mixer_handle_upload_mod_and_play(ks_task_t *task,
      void *task_data,
      void *user_data, const char *err)
{
   audio_mixer_stream_params_t params;
...
#ifdef HAVE_RWAV
static void task_audio_mixer_handle_upload_wav(ks_task_t *task,
      void *task_data,
      void *user_data, const char *err)
{
   audio_mixer_stream_params_t params;
...
static void task_audio_mixer_handle_upload_wav_and_play(ks_task_t *task,
      void *task_data,
      void *user_data, const char *err)
{
   audio_mixer_stream_params_t params;
...
error:
   ...
   KINGSN_ERR("[audio mixer load] Failed to open '%s': %s.\n",
