   ...
   switch (msg)
   {
      case MENU_ENUM_LABEL_CORE_LIST:
         snprintf(s, len,
               ...
               "libks. Onde a busca inicia depende \n"
      ...
      case MENU_ENUM_LABEL_LIBKS_LOG_LEVEL:
         snprintf(s, len,
               ...
               " libks estiver abaixo de libks_log, \n"
               " esse será ignorado.\n"
               " \n"
      ...
      case MENU_ENUM_LABEL_ENABLE_HOTKEY:
         snprintf(s, len,
               ...
               " \n"
               "Isso é útil para implementações KS_KEYBOARD que \n"
      ...
      case MENU_ENUM_LABEL_REWIND_GRANULARITY:
         snprintf(s, len,
               "Granularidade da função de kscedimento \n"
               "do tempo.\n"
               "Ao ksceder um número definido de \n"
               "fotogramas, você poderá ksceder vários \n"
      ...
      case MENU_ENUM_LABEL_REWIND:
         snprintf(s, len,
               ...
               "ativar o kscedimento do tempo. \n"
               "O kscedimento de tempo deve estar ativo.");
         break;
