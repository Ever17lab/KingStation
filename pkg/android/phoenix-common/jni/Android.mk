...
LIBKS_COMM_DIR := $(KINGSN_DIR)/libks-common
DEPS_DIR          := $(KINGSN_DIR)/deps
...
ifeq ($(HAVE_NEON),1)
   ...
   LOCAL_SRC_FILES += $(LIBKS_COMM_DIR)/audio/conversion/s16_to_float_neon.S.neon \
							 $(LIBKS_COMM_DIR)/audio/conversion/float_to_s16_neon.S.neon \
							 $(LIBKS_COMM_DIR)/audio/resampler/drivers/sinc_resampler_neon.S.neon \
							 $(KINGSN_DIR)/audio/drivers_resampler/cc_resampler_neon.S.neon
endif
...
LOCAL_SRC_FILES  +=	$(KINGSN_DIR)/griffin/griffin.c \
							$(KINGSN_DIR)/griffin/griffin_cpp.cpp
...
DEFINES += -DKINGSN_MOBILE -DHAVE_GRIFFIN -DHAVE_STB_VORBIS -DHAVE_LANGEXTRA -DANDROID -DHAVE_DYNAMIC -DHAVE_OPENGL -DHAVE_OVERLAY -DHAVE_VIDEO_LAYOUT -DHAVE_OPENGLES -DGLSL_DEBUG -DHAVE_DYLIB -DHAVE_EGL -DHAVE_GLSL -DHAVE_MENU -DHAVE_CONFIGFILE -DHAVE_PATCH -DHAVE_DSP_FILTER -DHAVE_VIDEO_FILTER -DHAVE_SCREENSHOTS -DHAVE_REWIND -DHAVE_CHEATS -DHAVE_RGUI -DHAVE_ZLIB -DHAVE_NO_BUILTINZLIB -DHAVE_RPNG -DHAVE_RJPEG -DHAVE_RBMP -DHAVE_RTGA -DINLINE=inline -DHAVE_THREADS -D__LIBKS__ -DHAVE_RSOUND -DHAVE_NETWORKGAMEPAD -DHAVE_NETWORKING -DHAVE_NETPLAYDISCOVERY -DKINGSN_INTERNAL -DHAVE_FILTERS_BUILTIN -DHAVE_MATERIALUI -DHAVE_XMB -DHAVE_OZONE -DHAVE_SHADERPIPELINE -DHAVE_LIBKSDB -DHAVE_STB_FONT -DHAVE_IMAGEVIEWER -DHAVE_ONLINE_UPDATER -DHAVE_UPDATE_ASSETS -DHAVE_UPDATE_CORES -DHAVE_CC_RESAMPLER -DHAVE_MINIUPNPC -DHAVE_BUILTINMINIUPNPC -DMINIUPNPC_SET_SOCKET_TIMEOUT -DMINIUPNPC_GET_SRC_ADDR -DHAVE_KEYMAPPER -DHAVE_NETWORKGAMEPAD -DHAVE_FLAC -DHAVE_DR_FLAC -DHAVE_DR_MP3 -DHAVE_CHD -DWANT_SUBCODE -DWANT_RAW_DATA_SECTOR -DHAVE_RUNAHEAD -DENABLE_HLSL -DHAVE_AUDIOMIXER -DHAVE_RWAV
...
LOCAL_C_INCLUDES := \
							$(LOCAL_PATH)/$(KINGSN_DIR)/libks-common/include/ \
							$(LOCAL_PATH)/$(KINGSN_DIR)/deps \
							$(LOCAL_PATH)/$(KINGSN_DIR)/deps/stb \
							$(LOCAL_PATH)/$(KINGSN_DIR)/deps/7zip
...
ifeq ($(HAVE_VULKAN),1)
INCFLAGS         += $(LOCAL_PATH)/$(KINGSN_DIR)/gfx/include
...
LOCAL_SRC_FILES += $(KINGSN_DIR)/griffin/griffin_glslang.cpp
endif
