...
static void input_autoconfigure_free(ks_task_t *task)
{
...
static void input_autoconfigure_connect_handler(ks_task_t *task)
{
   autoconfig_handle_t *autoconfig_handle = NULL;
   bool match_found                       = false;
...
static bool autoconfigure_connect_finder(ks_task_t *task, void *user_data)
{
   autoconfig_handle_t *autoconfig_handle = NULL;
   unsigned *port                         = NULL;
...
static void input_autoconfigure_disconnect_handler(ks_task_t *task)
{
   autoconfig_handle_t *autoconfig_handle = NULL;
   char task_title[PATH_MAX_LENGTH];
...
static bool autoconfigure_disconnect_finder(ks_task_t *task, void *user_data)
{
   autoconfig_handle_t *autoconfig_handle = NULL;
   unsigned *port                         = NULL;
