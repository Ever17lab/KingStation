...
- (void)webServerDidCompleteBonjourRegistration:(GCDWebServer*)server
{
    ...
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"Welcome to KingStation" message:[NSString stringWithFormat:@"To transfer files from your computer, go to one of these addresses on your web browser:\n\n%@",servers] preferredStyle:UIAlertControllerStyleAlert];
#if TARGET_OS_TV
...
void *cocoa_screen_get_chosen(void)
{
    ...
    {
        KINGSN_WARN("video_monitor_index is greater than the number of connected monitors; using main screen instead.");
