...
DEFAULT_TITLE_MACRO(action_get_user_accounts_cheevos_list,      MENU_ENUM_LABEL_VALUE_ACCOUNTS_KS_ACHIEVEMENTS)
...
DEFAULT_TITLE_MACRO(action_get_ks_achievements_settings_list,MENU_ENUM_LABEL_VALUE_KS_ACHIEVEMENTS_SETTINGS)
...
DEFAULT_FILL_TITLE_MACRO(action_get_title_core_directory,       MENU_ENUM_LABEL_VALUE_LIBKS_DIR_PATH)
DEFAULT_FILL_TITLE_MACRO(action_get_title_core_info_directory,  MENU_ENUM_LABEL_VALUE_LIBKS_INFO_PATH)
...
static int action_get_title_default(const char *path, const char *label,
      unsigned menu_type, char *s, size_t len)
{
   strlcpy(s, msg_hash_to_str(MENU_ENUM_LABEL_VALUE_LOAD_CONTENT_LIST), len);
   return 0;
}
      ...
      const char *label)
{
   ...
   title_info_list_t info_list[] = {
      ...
      {MENU_ENUM_LABEL_DEFERRED_KS_ACHIEVEMENTS_SETTINGS_LIST,     action_get_ks_achievements_settings_list},
