...
MSG_HASH(
   ...
   "كتابة ملفات حفظ غير متطايرة بصيغة محفوظة. يقلل بشكل كبير حجم الملف على حساب (قليل) زيادة أوقات التوفير/التحميل. ملاحظة: ينطبق فقط على النواة التي تمكن التوفير عبر واجهة Libks SaveRAM القياسية."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "عنوان URL لدليل التحديث الأساسي على قاعدة Libks buildbot."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "عادة ما يقوم المطورين بضم تطبيقات libks/KingStation للإشارة إلى الأصول."
   )
MSG_HASH(
