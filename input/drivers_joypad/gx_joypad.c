   ...
   for (port = 0; port < DEFAULT_MAX_PADS; port++)
   {
      ...
      if (gcpad & (1 << port))
      {
         ...
         *state_cur |= ((down & PAD_TRIGGER_R) || PAD_TriggerR(port) > 127) ? (UINT64_C(1) << GX_GC_R_TRIGGER) : 0;
         ...
         analog_state[port][KS_DEVICE_INDEX_ANALOG_LEFT][KS_DEVICE_ID_ANALOG_X] = ls_x;
         analog_state[port][KS_DEVICE_INDEX_ANALOG_LEFT][KS_DEVICE_ID_ANALOG_Y] = ls_y;
         analog_state[port][KS_DEVICE_INDEX_ANALOG_RIGHT][KS_DEVICE_ID_ANALOG_X] = rs_x;
         analog_state[port][KS_DEVICE_INDEX_ANALOG_RIGHT][KS_DEVICE_ID_ANALOG_Y] = rs_y;
         ...
         *state_cur |= (down & WPAD_BUTTON_HOME) ? (UINT64_C(1) << GX_WIIMOTE_HOME) : 0;
         ...
         if (ptype == WPAD_EXP_CLASSIC)
         {
            ...
            *state_cur |= (down & WPAD_CLASSIC_BUTTON_ZR) ? (UINT64_C(1) << GX_CLASSIC_ZR_TRIGGER) : 0;
            ...
            analog_state[port][KS_DEVICE_INDEX_ANALOG_LEFT][KS_DEVICE_ID_ANALOG_X]  = WPAD_StickX(wpaddata, 0);
            analog_state[port][KS_DEVICE_INDEX_ANALOG_LEFT][KS_DEVICE_ID_ANALOG_Y]  = WPAD_StickY(wpaddata, 0);
            analog_state[port][KS_DEVICE_INDEX_ANALOG_RIGHT][KS_DEVICE_ID_ANALOG_X] = WPAD_StickX(wpaddata, 1);
            analog_state[port][KS_DEVICE_INDEX_ANALOG_RIGHT][KS_DEVICE_ID_ANALOG_Y] = WPAD_StickY(wpaddata, 1);
         }
