...
GENERIC_DEFERRED_PUSH(deferred_push_ks_achievements_settings_list,DISPLAYLIST_KS_ACHIEVEMENTS_SETTINGS_LIST)
      ...
      unsigned id, enum menu_displaylist_ctl_state state)
{
   ...
   {
      struct ks_system_info sysinfo = {0};
      ...
      if (multimedia_builtin_mediaplayer_enable)
      {
         ...
         libks_ffmpeg_ks_get_system_info(&sysinfo);
#elif defined(HAVE_MPV)
         libks_mpv_ks_get_system_info(&sysinfo);
#endif
      ...
      {
         libks_imageviewer_ks_get_system_info(&sysinfo);
         strlcat(newstring2, "|", sizeof(newstring2));
      ...
      const char *label)
{
   ...
   const deferred_info_list_t info_list[] = {
      ...
      {MENU_ENUM_LABEL_DEFERRED_KS_ACHIEVEMENTS_SETTINGS_LIST, deferred_push_ks_achievements_settings_list},
