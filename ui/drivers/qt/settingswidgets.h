...
public:
   ...
   void addSizeSpinBox(kingsn_setting_t *setting, unsigned scale = 1024 * 1024);
   void addUIntColorButton(const QString &title, msg_hash_enums r, msg_hash_enums g, msg_hash_enums b);
   void addUIntSpinBox(kingsn_setting_t *setting);
   void addFloatSpinBox(kingsn_setting_t *setting);
   void addCheckBox(kingsn_setting_t *setting);
   void addUIntComboBox(kingsn_setting_t *setting);
   bool addBindButton(kingsn_setting_t *setting);
   void addFileSelector(kingsn_setting_t *setting);
   void addDirectorySelector(kingsn_setting_t *setting);
   void addFloatSliderAndSpinBox(kingsn_setting_t *setting);
   void addUIntRadioButtons(kingsn_setting_t *setting);
   void addStringComboBox(kingsn_setting_t *setting);
   void addStringLineEdit(kingsn_setting_t *setting);
   void addPasswordLineEdit(kingsn_setting_t *setting);

   bool add(kingsn_setting_t *setting)
   {
...
private:
   void addBindButton(kingsn_setting_t *setting);
   void addCheckBox(kingsn_setting_t *setting);
   void addUIntSpinBox(kingsn_setting_t *setting);
   void addUIntComboBox(kingsn_setting_t *setting);
   void addFloatSpinBox(kingsn_setting_t *setting);
...
class CheckableSettingsGroup : public SettingsGroup
{
   Q_OBJECT
public:
   CheckableSettingsGroup(kingsn_setting_t *setting, QWidget *parent = 0);
...
class CheckBox : public QCheckBox
{
   Q_OBJECT
public:
   CheckBox(kingsn_setting_t *setting, QWidget *parent = 0);
...
class CheckableIcon : public QToolButton
{
   Q_OBJECT
public:
   CheckableIcon(kingsn_setting_t *setting, const QIcon &icon, QWidget *parent = 0);
...
class StringLineEdit : public QLineEdit
{
   Q_OBJECT
public:
   StringLineEdit(kingsn_setting_t *setting, QWidget *parent = 0);
...
class PasswordLineEdit : public StringLineEdit
{
   Q_OBJECT
public:
   PasswordLineEdit(kingsn_setting_t *setting, QWidget *parent = 0);
};
...
class StringComboBox : public QComboBox
{
   Q_OBJECT
public:
   StringComboBox(kingsn_setting_t *setting, QWidget *parent = 0);
...
class UIntComboBox : public QComboBox
{
   Q_OBJECT
public:
   UIntComboBox(kingsn_setting_t *setting, QWidget *parent = 0);
   UIntComboBox(kingsn_setting_t *setting, double min, double max, QWidget *parent = 0);
...
class UIntRadioButton : public QRadioButton
{
   Q_OBJECT
public:
   UIntRadioButton(const QString &text, kingsn_setting_t *setting, unsigned value, QWidget *parent = 0);
...
class UIntRadioButtons : public QGroupBox
{
   Q_OBJECT
public:
   UIntRadioButtons(kingsn_setting_t *setting, QWidget *parent = 0);
...
class UIntSpinBox : public QSpinBox
{
   Q_OBJECT
public:
   UIntSpinBox(kingsn_setting_t *setting, QWidget *parent = 0);
...
class SizeSpinBox : public QSpinBox
{
   Q_OBJECT
public:
   SizeSpinBox(kingsn_setting_t *setting, unsigned scale = 1024*1024, QWidget *parent = 0);
...
class IntSpinBox : public QSpinBox
{
   Q_OBJECT
public:
   IntSpinBox(kingsn_setting_t *setting, QWidget *parent = 0);
private slots:
   void onValueChanged(int value);
   void paintEvent(QPaintEvent *event);
private:
...
class FloatSpinBox : public QDoubleSpinBox
{
   Q_OBJECT
public:
   FloatSpinBox(kingsn_setting_t *setting, QWidget *parent = 0);
...
class PathButton : public QPushButton
{
   Q_OBJECT
public:
   PathButton(kingsn_setting_t *setting, QWidget *parent = 0);
...
class DirectoryButton : public PathButton
{
   Q_OBJECT
public:
   DirectoryButton(kingsn_setting_t *setting, QWidget *parent = 0) :
...
class FileButton : public PathButton
{
   Q_OBJECT
public:
   FileButton(kingsn_setting_t *setting, QWidget *parent = 0) :
      PathButton(setting, parent) {}
private:
   void onClicked(bool checked = false);
};
...
class DirectorySelector : public QHBoxLayout
{
   Q_OBJECT
public:
   DirectorySelector(kingsn_setting_t *setting, QWidget *parent = 0);
private:
...
class FileSelector : public QHBoxLayout
{
   Q_OBJECT
public:
   FileSelector(kingsn_setting_t *setting, QWidget *parent = 0);
...
class FloatSlider : public QSlider
{
   Q_OBJECT
public:
   FloatSlider(kingsn_setting_t *setting, QWidget *parent = 0);
...
class FloatSliderAndSpinBox : public QHBoxLayout
{
   Q_OBJECT
public:
   FloatSliderAndSpinBox(kingsn_setting_t *setting, QWidget *parent = 0);
...
class BindButton : public QPushButton
{
   Q_OBJECT
public:
   BindButton(kingsn_setting_t *setting, QWidget *parent = 0);
...
class ColorButton : public QToolButton
{
   Q_OBJECT
public:
   ColorButton(kingsn_setting_t *red, kingsn_setting_t *green, kingsn_setting_t *blue, QWidget *parent = 0);
...
protected:
   ...
   kingsn_setting_t *m_red, *m_green, *m_blue;
...
public:
   ...
   UIntColorButton(kingsn_setting_t *red, kingsn_setting_t *green, kingsn_setting_t *blue, QWidget *parent = 0);
protected slots:
