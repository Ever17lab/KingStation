         ...
         msg >= MENU_ENUM_LABEL_INPUT_HOTKEY_BIND_BEGIN)
   {
      ...
      switch (idx)
      {
         ...
         case KINGSN_QUIT_KEY:
            snprintf(s, len,
                  "Nút để an toàn thoát KingStation. \n"
                  " \n"
   ...
   switch (msg)
   {
      case MENU_ENUM_LABEL_ACCOUNTS_KS_ACHIEVEMENTS:
         snprintf(s, len, "Chi tiết đăng nhập cho tài khoản \n"
               ...
               " \n"
               "Truy cập ksachievements.org đễ \n"
      ...
      case MENU_ENUM_LABEL_LOAD_CONTENT_HISTORY:
         snprintf(s, len,
               ...
               "thư mục as the KingStation config file. If \n"
      ...
      case MENU_ENUM_LABEL_SAVESTATE_AUTO_LOAD:
         snprintf(s, len,
               ...
               " \n"
               "KingStation will automatically tải any savestate\n"
      ...
      case MENU_ENUM_LABEL_PAUSE_LIBKS:
         snprintf(s, len,
               "If disabled, the libks core will keep \n"
