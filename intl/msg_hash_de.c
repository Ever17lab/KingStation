      ...
      switch (idx) {
         ...
         case KINGSN_GRAB_MOUSE_TOGGLE:
            snprintf(s, len,
                  ...
                  " \n"
                  "Wenn die Maus eingefangen ist, versteckt KingStation \n"
                  "die Maus und hält den Mauszeiger im KingStation-Fenster, \n"
         ...
         case KINGSN_GAME_FOCUS_TOGGLE:
             snprintf(s, len,
                   ...
                   " \n"
                   "Wenn ein Spiel fokussiert ist, wird KingStation die Tastenkürzel\n"
                   "deaktivieren und den Mauszeiger im KingStation-Fenster halten.");
             break;
         ...
         case KINGSN_QUIT_KEY:
            snprintf(s, len,
                  "Taste zum Beenden von KingStation. \n"
                  " \n"
                  "Ein 'hartes' Beenden des Prozesses (SIGKILL, etc.) wird \n"
                  "KingStation beenden, ohne Arbeitsspeicher oder ähnliches zu speichern."
#ifdef __unix__
                  "\nAuf unixoiden Systemen erlaubt SIGINT/SIGTERM ein sauberes \n"
                  "Beenden von KingStation."
#endif
                  "");
            break;
   ...
   switch (msg)
   {
      case MENU_ENUM_LABEL_ACCOUNTS_KS_ACHIEVEMENTS:
         snprintf(s, len, "Anmelde-Daten für dein \n"
               ...
               " \n"
               "Besuche ksachievements.org und eröffne \n"
               "ein kostenloses Konto. \n"
               " \n"
               "Nach der Registrierung musst du deinen \n"
               "Benutzernamen und dein Passwort in KingStation \n"
               "angeben.");
         break;
      ...
      case MENU_ENUM_LABEL_SORT_SAVESTATES_ENABLE:
         snprintf(s, len, "Speichert Zustandsdaten (Savestates) in Ordnern, \n"
               "die nach dem verwendeten Libks-Core benannt sind.");
         break;
      ...
      case MENU_ENUM_LABEL_LIBKS_INFO_PATH:
         snprintf(s, len,
               ...
               "Libks-Core-Informationen gesucht wird.");
         break;
      ...
      case MENU_ENUM_LABEL_FILE_BROWSER_CORE:
         snprintf(s, len,
               "Libks-Core. \n"
               " \n"
               "Auswählen, um diesen Core in KingStation zu laden.");
         break;
      ...
      case MENU_ENUM_LABEL_CACHE_DIRECTORY:
         snprintf(s, len,
               ...
               " \n"
               "Von KingStation entpackter Inhalt wird \n"
               "vorübergehend in diesem Verzeichnis gespeichert.");
         break;
      case MENU_ENUM_LABEL_HISTORY_LIST_ENABLE:
         snprintf(s, len,
               "Wenn aktiviert, wird jeder Inhalt, der in KingStation \n"
      ...
      case MENU_ENUM_LABEL_CORE_LIST:
         snprintf(s, len,
               "Lädt einen Core. \n"
               " \n"
               "Suche nach einer Libks-Core-Implementierung. \n"
      ...
      case MENU_ENUM_LABEL_VALUE_HELP_AUDIO_VIDEO_TROUBLESHOOTING_DESC:
         {
            ...
            char u[501];
            const char * t =
                  "KingStation verwendet eine einzigartige Form der\n"
      ...
      case MENU_ENUM_LABEL_LOAD_CONTENT_LIST:
         snprintf(s, len,
               ...
               "Libks-Core und die Inhalts-Datei. \n"
               " \n"
      ...
      case MENU_ENUM_LABEL_LOAD_CONTENT_HISTORY:
         snprintf(s, len,
               ...
               "KingStation-Konfigurationsdatei gespeichert. Wenn \n"
      ...
      case MENU_ENUM_LABEL_VIDEO_DRIVER:
         {
            ...
            if (string_is_equal(video_driver, "gl"))
            {
               snprintf(s, len,
                     ...
                     "gerenderten Cores auch Libks-GL-Cores zu \n"
                     "verwenden. \n"
                     " \n"
                     "Die Leistung, sowohl bei software-gerenderten, \n"
                     "als auch bei Libks-GL-Cores, hängt von dem \n"
      ...
      case MENU_ENUM_LABEL_VIDEO_SHADER_NUM_PASSES:
         snprintf(s, len,
               "Shader-Durchgänge. \n"
               " \n"
               "KingStation erlaubt es, verschiedene Shader \n"
      ...
      case MENU_ENUM_LABEL_CONFIRM_ON_EXIT:
         snprintf(s, len, "Bist du sicher, dass du KingStation verlassen möchtest?");
         break;
      ...
      case MENU_ENUM_LABEL_INPUT_BIND_DEVICE_TYPE:
         snprintf(s, len,
               ...
               "Dies ist für den Libks-Core selbst relevat."
               );
         break;
      case MENU_ENUM_LABEL_LIBKS_LOG_LEVEL:
         snprintf(s, len,
               ...
               " \n"
               " Wenn ein Libks-Core ein Log-Level unterhalb \n"
      ...
      case MENU_ENUM_LABEL_SHADER_APPLY_CHANGES:
         snprintf(s, len,
               ...
               "bleibt nach dem Beenden von KingStation bestehen. Die Datei \n"
      ...
      case MENU_ENUM_LABEL_GAME_FOCUS_TOGGLE:
         snprintf(s, len,
                   "Spiel-Fokus umschalten.\n"
                   " \n"
                   "Wenn ein Spiel fokussiert ist, wird KingStation die Hotkeys\n"
                   "deaktivieren and und den Mauszeiger im KingStation-Fenster halten.");
         break;
      ...
      case MENU_ENUM_LABEL_ENABLE_HOTKEY:
         {
            ...
            const char * u =
                  ...
                  "KS_KEYBOARD ausgelegt sind und eine große \n"
      ...
      case MENU_ENUM_LABEL_LIBKS_DIR_PATH:
         snprintf(s, len,
               ...
               "Libks-Core-Implementierungen gesucht wird.");
         break;
      ...
      case MENU_ENUM_LABEL_VIDEO_ROTATION:
         snprintf(s, len,
               ...
               "die durch den Libks-Core festgelegt werden. (siehe 'Erlaube \n"
               "Bild-Drehung').");
         break;
      ...
      case MENU_ENUM_LABEL_FASTFORWARD_RATIO:
         snprintf(s, len,
               ...
               "begrenzt).\n"
               " \n"
               "KingStation wird pausieren, um sicherzustellen, \n"
      ...
      case MENU_ENUM_LABEL_VIDEO_MONITOR_INDEX:
         snprintf(s, len,
               ...
               "Bildschirm dar), bewirkt, dass KingStation diesen \n"
      ...
      case MENU_ENUM_LABEL_SAVESTATE_AUTO_LOAD:
         snprintf(s, len,
               ...
               "wenn KingStation beendet wird .\n"
               " \n"
               "KingStation wird die Zustandsdaten in diesem Pfad automatisch \n"
      ...
      case MENU_ENUM_LABEL_PAUSE_LIBKS:
         snprintf(s, len,
               "Wenn deaktiviert, wird der Libks-Core im \n"
      ...
      case MENU_ENUM_LABEL_INPUT_MAX_USERS:
         snprintf(s, len,
               ...
               "KingStation unterstützt werden.");
         break;
      ...
      case MENU_ENUM_LABEL_NETPLAY_NICKNAME:
         snprintf(s, len,
               "Der Benutzername der Person, die KingStation verwendet. \n"
      ...
      case MENU_ENUM_LABEL_EXIT_EMULATOR:
         snprintf(s, len,
               "Taste zum sauberen Beenden von KingStation."
#if !defined(KINGSN_MOBILE) && !defined(KINGSN_CONSOLE)
               "\nWenn du KingStation 'unsanft' beendest (SIGKILL, \n"
      ...
      case MENU_ENUM_LABEL_VALUE_WHAT_IS_A_CORE_DESC:
         snprintf(s, len,
               "KingStation selbst tut nichts. \n"
               " \n"
               "Damit KingStation etwas tut, musst \n"
               "du ein Programm hineinladen. \n"
               "\n"
               "Wir nennen diese Programme 'Libks-Core', \n"
               ...
               msg_hash_to_str(MENU_ENUM_LABEL_VALUE_LIBKS_DIR_PATH)
#else
