...
cd ../pkg/msvc/
devenv /clean Release_LTCG KingStation-Xbox1.sln
devenv /build Release_LTCG KingStation-Xbox1.sln
copy KingStation-Xbox1\Release_LTCG\KingStation.xbe KingStation-Xbox1\%1.xbe
del KingStation-Xbox1\Release_LTCG\KingStation.xbe
del KingStation-Xbox1\Release_LTCG\libks_xdk1.lib
exit
