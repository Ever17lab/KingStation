...
MSG_HASH(
   ...
   "Caricamento run-time dinamico della libreria libks"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Scrive file SaveRAM non volatili in un formato archiviato. Riduce drasticamente la dimensione del file a discapito di un (trascurabile) aumento dei tempi di salvataggio/caricamento. Nota: si applica solamente ai core che abilitano il salvataggio tramite l'interfaccia standard libks SaveRAM."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Guadagna trofei nei giochi classici. Per ulteriori informazioni, visita 'https://ksachievements.org'."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "URL alla directory di aggiornamento del core nel buildbot di Libks."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "URL della directory di aggiornamento delle risorse nel buildbot Libks."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Di solito impostato dagli sviluppatori,perchè raggruppa le applicazioni libks / KingStation dove vengono visualizzate le loro attività."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Il core Libks richiede contenuti, ma nessun dato è stato fornito.."
   )
MSG_HASH(
   MSG_ERROR_LIBKS_CORE_REQUIRES_SPECIAL_CONTENT,
   "I core Libks richiedono contenuti speciali, ma nessun dato è stato fornito."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Impossibile aprire il core libks"
   )
MSG_HASH(
   MSG_FAILED_TO_PATCH,
   "Patch non riuscita"
...
MSG_HASH(
   ...
   "Il core Libks è reso hardware. Deve usare anche la registrazione post-ombreggiata."
   )
MSG_HASH(
...
MSG_HASH(
   MSG_LIBKS_ABI_BREAK,
   "è compilato con una versione diversa di libks di questa implementazione di libks."
   )
MSG_HASH(
   MSG_LIBKS_FRONTEND,
   "Frontend per libks"
...
MSG_HASH(
   ...
   "Usare il nucleo fittizio libks. Registrazione saltata."
   )
MSG_HASH(
