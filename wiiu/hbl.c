...
void log_rpx(const char *filepath, unsigned char *buf, size_t len)
{
   ...
   KINGSN_LOG("=== BEGIN file=%s size=%d ===\n", filepath, len);
   ...
   for (i = 0; i < len; i++)
   {
      ...
      {
         KINGSN_LOG("%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x\n",
