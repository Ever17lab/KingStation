...
var LibraryRWebCam = {
   $RWC: {
      ...
      KS_CAMERA_BUFFER_RAW_FRAMEBUFFER: 1,
      tmp: null,
   ...
   RWebCamInit: function(caps1, caps2, width, height) {
      ...
      RWC.contexts[c].glTex = caps1 & (1 << RWC.KS_CAMERA_BUFFER_OPENGL_TEXTURE);
      RWC.contexts[c].rawFb = caps1 & (1 << RWC.KS_CAMERA_BUFFER_RAW_FRAMEBUFFER);
