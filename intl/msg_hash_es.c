       ...
       switch (idx)
       {
          ...
          case KINGSN_SEND_DEBUG_INFO:
             snprintf(s, len,
                   ...
                   "tu dispositivo y la configuración de KingStation\n"
          ...
          case KINGSN_GRAB_MOUSE_TOGGLE:
             snprintf(s, len,
                   ...
                   " \n"
                   "Al capturar el ratón, KingStation lo ocultará\n"
          ...
          case KINGSN_GAME_FOCUS_TOGGLE:
             snprintf(s, len,
                     ...
                     " \n"
                     "Cuando el juego tiene prioridad, KingStation\n"
          ...
          case KINGSN_QUIT_KEY:
             snprintf(s, len,
               "Asigna una tecla para abandonar KingStation\n"
               "limpiamente.\n"
               " \n"
    ...
    switch (msg)
    {
        ...
        case MENU_ENUM_LABEL_SORT_SAVESTATES_ENABLE:
            snprintf(s, len, "Ordena los guardados rápidos mediante\n"
                    "carpetas con el nombre del núcleo libks\n"
                    "correspondiente.");
            break;
        ...
        case MENU_ENUM_LABEL_DUMMY_ON_CORE_SHUTDOWN:
            snprintf(s, len,
                     ...
                     "también se cerrará KingStation.\n"
                     " \n"
                     "De lo contrario, en vez de cerrar KingStation\n"
        ...
        case MENU_ENUM_LABEL_FILE_BROWSER_CORE:
            snprintf(s, len,
                     "Núcleo libks.\n"
                     " \n"
                     "Selecciona este archivo para que KingStation\n"
                     "cargue este núcleo.");
            break;
        ...
        case MENU_ENUM_LABEL_CACHE_DIRECTORY:
            snprintf(s, len,
                     "Carpeta de caché.\n"
                     " \n"
                     "Los contenidos descomprimidos por KingStation\n"
                     "se guardarán temporalmente en esta carpeta.");
            break;
        case MENU_ENUM_LABEL_HISTORY_LIST_ENABLE:
            snprintf(s, len,
                     "Si esta opción está activada, todos los\n"
                     "contenidos cargados en KingStation se agregarán\n"
        ...
        case MENU_ENUM_LABEL_CORE_LIST:
            snprintf(s, len,
                     "Carga un núcleo.\n"
                     " \n"
                     "Busca una implementación de un núcleo libks.\n"
        ...
        case MENU_ENUM_LABEL_WELCOME_TO_KingStation:
            snprintf(s, len,
                     "Te damos la bienvenida a KingStation.\n");
            break;
        case MENU_ENUM_LABEL_VALUE_HELP_AUDIO_VIDEO_TROUBLESHOOTING_DESC: {
            ...
            char u[501];
            const char *t =
                     "KingStation utiliza un formato único para\n"
        ...
        case MENU_ENUM_LABEL_LOAD_CONTENT_HISTORY:
            snprintf(s, len,
                     ...
                     "de KingStation. Si no se ha cargado un archivo\n"
                     "al iniciar KingStation, no se guardará ni cargará\n"
        ...
        case MENU_ENUM_LABEL_VIDEO_DRIVER:
            {
               ...
               if (string_is_equal(video_driver, "gl"))
               {
                  snprintf(s, len,
                        ...
                        "OpenGL de libks, más las implementaciones\n"
                        "renderizadas por software.\n"
                        " \n"
                        "El rendimiento de las implementaciones\n"
                        "libks por software y OpenGL dependen\n"
        ...
        case MENU_ENUM_LABEL_VIDEO_SHADER_NUM_PASSES:
            snprintf(s, len,
               "Pases de shaders.\n"
               " \n"
               "KingStation permite combinar diversos shaders\n"
        ...
        case MENU_ENUM_LABEL_INPUT_BIND_DEVICE_TYPE:
            snprintf(s, len,
               ...
               "Afecta al núcleo libks."
            );
            break;
        case MENU_ENUM_LABEL_LIBKS_LOG_LEVEL:
            snprintf(s, len,
               "Ajusta el nivel de registro de los\n"
               "núcleos libks (GET_LOG_INTERFACE).\n"
               " \n"
               " Si el nivel de un registro de un núcleo\n"
               " libks está por debajo del nivel indicado\n"
               " en libks_log, será ignorado.\n"
               " \n"
        ...
        case MENU_ENUM_LABEL_SHADER_APPLY_CHANGES:
            snprintf(s, len,
               ...
               "KingStation y se guardará en la carpeta Shader."
            );
            break;
        ...
        case MENU_ENUM_LABEL_ENABLE_HOTKEY:
            snprintf(s, len,
                     ...
                     "en KS_KEYBOARD, que ocupan una gran porción\n"
        ...
        case MENU_ENUM_LABEL_LIBKS_DIR_PATH:
            snprintf(s, len,
               ...
               "las implementaciones de núcleos libks.");
            break;
        ...
        case MENU_ENUM_LABEL_VIDEO_ROTATION:
            snprintf(s, len,
                     ...
                     "que indique el núcleo libks (ver\n"
                     "Rotación de vídeo).");
            break;
        ...
        case MENU_ENUM_LABEL_FASTFORWARD_RATIO:
            snprintf(s, len,
                     ...
                     "máximo de 300 FPS).\n"
                     " \n"
                     "KingStation pasará a segundo plano para asegurarse\n"
        ...
        case MENU_ENUM_LABEL_VIDEO_MONITOR_INDEX:
            snprintf(s, len,
                     ...
                     "a KingStation que utilice ese monitor específico.");
            break;
        ...
        case MENU_ENUM_LABEL_SAVESTATE_AUTO_LOAD:
            snprintf(s, len,
                     ...
                     "al cerrar KingStation.\n"
                     " \n"
                     "KingStation cargará al arrancar cualquier\n"
      ...
      case MENU_ENUM_LABEL_VIDEO_CTX_SCALING:
        ...
        case MENU_ENUM_LABEL_CORE_UPDATER_BUILDBOT_URL:
            snprintf(s, len,
                     ...
                     "de núcleos del buildbot libks.");
            break;
        case MENU_ENUM_LABEL_BUILDBOT_ASSETS_URL:
            snprintf(s, len,
                     "La dirección URL al directorio del actualizador\n"
                     "de recursos del buildbot libks.");
            break;
        ...
        case MENU_ENUM_LABEL_NETPLAY_NICKNAME:
            snprintf(s, len,
                     ...
                     "utilizando KingStation. Este nombre se utilizará\n"
        ...
        case MENU_ENUM_LABEL_VALUE_WHAT_IS_A_CORE_DESC:
            snprintf(s, len,
                     "KingStation, por sí solo, no hace nada.\n"
                     " \n"
                     "Para que haga algo necesitas cargar\n"
                     "programas que llamamos «núcleos libks»,\n"
                     "o núcleos a secas.\n"
                     " \n"
