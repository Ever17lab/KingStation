...
MSG_HASH(
   ...
   "Ouvre l'interface de bureau traditionnelle."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Désactive le mode kiosque. (Redémarrage requis)"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Télécharger des add-ons, des composants et du contenu pour KingStation."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Insère une image noire entre les images. Utile pour certains écrans à fréquence de rafraîchissement élevée pour éliminer la rémanence."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Décalage de la fenêtre d'affichage sur l'axe X. Cette option sera ignorée si l'option 'Échelle à l'entier' est activée."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Décalage de la fenêtre d'affichage sur l'axe Y. Cette option sera ignorée si l'option 'Échelle à l'entier' est activée."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Tronque quelques pixels sur les bords de l'image habituellement laissés vides par les développeurs, qui contiennent parfois aussi des pixels parasites. (Redémarrage requis)"
   )
...
MSG_HASH(
   ...
   "Nombre maximum d'utilisateurs pris en charge par KingStation."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Influence la façon dont les touches pressées sont détectées dans KingStation. Utiliser 'Précoce' ou 'Tardive' peut diminuer la latence, en fonction de votre configuration."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Conserve les combinaisons de touches de Windows à l'intérieur de l'application. (Redémarrage requis)"
   )
#endif
MSG_HASH(
...
MSG_HASH(
   ...
   "Durée (en images) après laquelle une touche est en mode turbo."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Force de la vibration (Redémarrer)"
   )
MSG_HASH(
   MENU_ENUM_SUBLABEL_INPUT_DINGUX_RUMBLE_GAIN,
   "Spécifie l'ampleur des effets de retour haptique."
   )
#endif
...
MSG_HASH(
   ...
   "Nécessite que la touche de raccourci Quitter soit pressée deux fois pour quitter KingStation."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Ajoute un délai en images avant que l'entrée normale ne soit bloquée après avoir appuyé (et maintenu) la touche 'Raccourcis activés' assignée. Permet l'entrée normale de la touche 'Raccourcis activés' lorsqu'elle est mappée à une autre action (RetroManette 'Select' par exemple)."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Ferme KingStation, en s'assurant que tous les fichiers de sauvegarde et de configuration sont enregistrés sur le disque."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "En maintenant la touche, cela active le rembobinage. Remarque : 'Prise en charge du rembobinage' doit être activé."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Lorsqu'il est en pause, avance le contenu d'une image."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Charge et applique le fichier de préréglages de shaders suivant à la racine du dossier 'Shaders vidéo'."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Envoie les informations de diagnostic pour votre appareil et la configuration de KingStation à nos serveurs pour analyse."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Incrémente le numéro du disque sélectionné actuellement. Remarque : le plateau du lecteur de disque virtuel doit être ouvert."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Décrémente le numéro du disque sélectionné actuellement. Remarque : le plateau du lecteur de disque virtuel doit être ouvert."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Capture ou relâche la souris. Lorsqu'elle est capturée, le curseur système est masqué et confiné à la fenêtre d'affichage de KingStation, améliorant le mouvement relatif de la souris."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Capture une image du contenu actuel puis traduit et/ou lit à haute voix tout texte à l'écran. Remarque : 'Service IA' doit être activé et configuré."
   )
...
MSG_HASH(
   ...
   "Nombre d'images à exécuter en avance. Provoque des problèmes de jeu tels que des variations de la latence si vous dépassez le nombre d'images de latence interne du jeu."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Utilise une seconde instance du cœur KingStation pour l'exécution en avance. Empêche les problèmes audio dus au chargement de l'état précédent."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Certains cœurs ont une fonctionnalité d'extinction, charger un cœur factice empêchera KingStation de se fermer."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Redémarrer KingStation lors du lancement de contenu, même lorsque le cœur demandé est déjà chargé. Cela peut améliorer la stabilité du système, au détriment d'un temps de chargement accru."
   )
#endif
MSG_HASH(
...
MSG_HASH(
   ...
   "Sauvegarde tous les réglages de cœurs dans un fichier de configuration commun (KingStation-core-options.cfg). Si cette option est désactivée, les réglages de chaque cœur seront sauvegardés vers un dossier/fichier de configuration spécifique au cœur séparé dans le dossier 'Config' de KingStation."
   )
...
MSG_HASH(
   ...
   "Sauvegarde automatiquement la mémoire SRAM non volatile à un intervalle régulier (en secondes)."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Limite le nombre de sauvegardes instantanées qui seront créées lorsque l'option 'Sauvegardes instantanées incrémentales' est activée. Si la limite est dépassée lors de l'enregistrement d'une nouvelle sauvegarde instantanée, la sauvegarde instantanée existante avec l'index le plus bas sera supprimée. Une valeur de '0' signifie que des sauvegardes instantanées illimitées seront enregistrés."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Crée automatiquement une sauvegarde instantanée à la fermeture de contenu. KingStation chargera cette sauvegarde instantanée automatiquement si 'Chargement auto des sauvegardes instantanées' est activé."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Enregistrer la mémoire SRAM non volatile sous un format archivé. Réduit considérablement la taille du fichier au détriment de l'augmentation (négligeable) des temps de sauvegarde/chargement. REMARQUE : S'applique uniquement aux cœurs qui peuvent sauvegarder via l'interface Save RAM standard de libks."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Lors de la journalisation vers un fichier, redirige la sortie de chaque session KingStation vers un nouveau fichier horodaté. Si désactivé, le journal est écrasé chaque fois que KingStation est redémarré."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Compteurs de performance pour KingStation et les cœurs. Les données de compteur peuvent aider à déterminer les goulots d'étranglement du système et à ajuster les performances."
   )
...
MSG_HASH(
   ...
   "Affiche le nombre d'images/s actuel."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Afficher/masquer des éléments du menu dans KingStation."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Si cette option est désactivée, le contenu continuera à fonctionner en arrière-plan lorsque le menu KingStation est activé."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Quitter automatiquement KingStation lors de la fermeture du contenu. 'CLI' quitte uniquement lorsque le contenu est lancé via la ligne de commande."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Mettre le jeu en pause lorsque KingStation n'est pas au premier plan."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Afficher 'Quitter KingStation'"
   )
MSG_HASH(
   MENU_ENUM_SUBLABEL_MENU_SHOW_QUIT_KingStation,
   "Afficher/masquer l'option 'Quitter KingStation'."
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_MENU_SHOW_RESTART_KingStation,
   "Afficher 'Redémarrer KingStation'"
   )
MSG_HASH(
   MENU_ENUM_SUBLABEL_MENU_SHOW_RESTART_KingStation,
   "Afficher/masquer l'option 'Redémarrer KingStation'."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Affiche des informations supplémentaires pour les éléments du menu."
   )
...
MSG_HASH(
   ...
   "Met à l'échelle les éléments de l'interface utilisateur dans le menu."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Active la synthèse vocale pour aider à la navigation dans le menu."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Gagnez des succès dans les jeux rétro. Pour plus d'informations, visitez 'https://ksachievements.org'."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "URL du dossier de mise à jour des cœurs sur le buildbot Libks."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "URL du dossier de mise à jour des assets sur le buildbot Libks."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Spécifie combien de sauvegardes générées automatiquement pour chaque cœur installé seront conservées. Lorsque cette limite est atteinte, la création d'une nouvelle sauvegarde via une mise à jour en ligne supprimera la sauvegarde la plus ancienne. Remarque : Les cœurs sauvegardés manuellement ne sont pas affectées par ce paramètre."
   )
...
MSG_HASH(
   ...
   "Trie les listes de lecture de contenu par ordre alphabétique, excluant les listes 'Historique', 'Images', 'Musique' et 'Vidéo'."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Règle le style de la date et l'heure affichées pour les informations d'horodatage dans 'Joué pour la dernière fois'. REMARQUE : Les options '(AM/PM)' auront un faible impact sur les performances pour certaines plateformes."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Détermine l'ordre de tri dans cette liste de lecture."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Valide les associations aux cœurs et supprime les entrées invalides/en double."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Définit le dossier système. Les cœurs peuvent rechercher des BIOS, des configurations spécifiques au système, etc. à cet emplacement."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Les assets de menu utilisés par KingStation sont conservés dans ce dossier."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Ouvre le plateau du lecteur de disque virtuel et retire le disque actuellement chargé. Si 'Mettre en pause le contenu lorsque le menu est actif' est activé, certains cœurs peuvent ne pas enregistrer les modifications à moins que le contenu ne soit repris pendant quelques secondes après chaque action liée au contrôle du disque."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Insère le disque correspondant au 'Numéro du disque actuel' et ferme le plateau du lecteur de disque virtuel. Si 'Mettre en pause le contenu lorsque le menu est actif' est activé, certains cœurs peuvent ne pas enregistrer les modifications à moins que le contenu ne soit repris pendant quelques secondes après chaque action liée au contrôle du disque."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Sélectionne un nouveau disque dans le système de fichiers puis l'insère sans fermer le plateau du lecteur de disque virtuel. REMARQUE : C'est une fonctionnalité obsolète. Il est plutôt recommandé de charger des titres multi-disques via des listes de lecture M3U, qui permettent la sélection du disque en utilisant l'option 'Numéro du disque actuel'."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Laisse le mode Hardcore des succès activé pour la session en cours"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Laisse le mode Hardcore des succès désactivé pour la session en cours"
   )
MSG_HASH(
...
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_KSPAD_WITH_ANALOG,
...
MSG_HASH(
   ...
   "Sélectionner un thème d'icônes différent pour KingStation."
   )
MSG_HASH(
...
MSG_HASH( /* FIXME Unused? */
   ...
   "Active l'onglet Réglages. (Redémarrage requis)"
   )
...
MSG_HASH(
   ...
   "Les listes de lecture seront re-triées par ordre alphabétique après avoir supprimé le composant fabricant de leurs noms. (Redémarrage requis)"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Mettre à jour KingStation (nightly)"
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_QT_UPDATE_KingStation_FINISHED,
   "KingStation a été mis à jour avec succès. Veuillez redémarrer l'application pour que les modifications prennent effet."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Envoyer les informations de diagnostic pour votre appareil et la configuration de KingStation à nos serveurs pour analyse."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Généralement défini par les développeurs qui compilent les applications libks/KingStation pour pointer vers des assets."
   )
MSG_HASH(
...
MSG_HASH( /* FIXME Should be MSG_ */
   ...
   "Votre pilote graphique n'est pas compatible avec le pilote vidéo actuel de KingStation, retour au pilote %s. Veuillez redémarrer KingStation pour que les modifications prennent effet."
   )
MSG_HASH( /* FIXME Should be MSG_ */
...
MSG_HASH(
   ...
   "Appuyez deux fois de plus pour soumettre les informations de diagnostic à l'équipe de KingStation."
   )
MSG_HASH(
   MSG_PRESS_ONE_MORE_TIME_TO_SEND_DEBUG_INFO,
   "Appuyez une fois de plus pour soumettre les informations de diagnostic à l'équipe de KingStation."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Une tentative de connexion de jeu en réseau à échouée car KingStation n'est pas en cours d'exécution chez le partenaire, ou est sur une version ancienne de KingStation."
   )
MSG_HASH(
   MSG_NETPLAY_OUT_OF_DATE,
   "Le partenaire de jeu en réseau est sur une version ancienne de KingStation. Connexion impossible."
   )
MSG_HASH(
   MSG_NETPLAY_DIFFERENT_VERSIONS,
   "ATTENTION : Un partenaire de jeu en réseau est sur une version différente de KingStation. Si des problèmes surviennent, utilisez la même version."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Le cœur Libks nécessite du contenu, mais aucun n'a été fourni."
   )
MSG_HASH(
   MSG_ERROR_LIBKS_CORE_REQUIRES_SPECIAL_CONTENT,
   "Le cœur Libks nécessite un contenu spécial, mais aucun n'a été fourni."
   )
MSG_HASH(
   MSG_ERROR_LIBKS_CORE_REQUIRES_VFS,
...
MSG_HASH(
   ...
   "Échec de l'ouverture du cœur Libks"
   )
MSG_HASH(
   MSG_FAILED_TO_PATCH,
   "Échec du patch"
...
MSG_HASH(
   ...
   "Le cœur Libks utilise le rendu matériel. Doit également utiliser les filtres vidéo lors de l'enregistrement."
   )
MSG_HASH(
...
MSG_HASH(
   MSG_LIBKS_ABI_BREAK,
   "est compilé avec une version différente de l'implémentation de libks actuelle."
   )
MSG_HASH(
   MSG_LIBKS_FRONTEND,
   "Frontend pour libks"
...
MSG_HASH(
   ...
   "Utilisation du cœur libks factice. Enregistrement ignoré."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Quitte puis redémarre KingStation. Requis pour l'activation de certains paramètres du menu (lors d'un changement du pilote de menu, par exemple)."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Scan terminé.<br><br>\nPour que le contenu soit correctement analysé, vous devez :\n<ul><li>avoir un cœur compatible déjà téléchargé</li>\n<li>avoir les \"Fichiers d'information de cœurs\" à jour via la mise à jour en ligne</li>\n<li>avoir les \"Bases de données\" à jour via la mise à jour en ligne</li>\n<li>redémarrer KingStation si l'une des opérations ci-dessus vient d'être effectuée</li></ul>\nEnfin, le contenu doit correspondre aux bases de données existantes <a href=\"https://docs.libks.com/guides/roms-playlists-thumbnails/#sources\">ici</a>. Si cela ne fonctionne toujours pas, veuillez envisager de <a href=\"https://www.github.com/libks/KingStation/issues\">soumettre un rapport d'erreur</a>."
   )
#endif
