...
static float ozone_sidebar_gradient_top_gruvbox_dark[16] = {
      0.0960784f, 0.0882353f, 0.0843137f, 1.0f,
      0.0960784f, 0.0882353f, 0.0843137f, 1.0f,
      0.0686275f, 0.0686275f, 0.0686275f, 0.9f,
      0.0686275f, 0.0686275f, 0.0686275f, 0.9f,
};
...
static float ozone_background_libks_running_light[16] = {
...
static float ozone_background_libks_running_dark[16] = {
...
static float ozone_background_libks_running_nord[16] = {
...
static float ozone_background_libks_running_gruvbox_dark[16] = {
...
static float ozone_background_libks_running_boysenberry[16] = {
...
static float ozone_background_libks_running_hacking_the_kernel[16] = {
...
static float ozone_background_libks_running_twilight_zone[16] = {
...
static float ozone_border_1_gruvbox_dark[16] = COLOR_HEX_TO_FLOAT(0xDD6600, 1.0f);
...
ozone_theme_t ozone_theme_light = {
   ...
   ozone_background_libks_running_light,
...
ozone_theme_t ozone_theme_dark = {
   ...
   ozone_background_libks_running_dark,
...
ozone_theme_t ozone_theme_nord = {
   ...
   ozone_background_libks_running_nord, /* background_libks_running */
...
ozone_theme_t ozone_theme_gruvbox_dark = {
   /* Background color */
   COLOR_HEX_TO_FLOAT(0x171717, 1.0f),             /* background */
   ozone_background_libks_running_gruvbox_dark, /* background_libks_running */

   /* Float colors for quads and icons */
   COLOR_HEX_TO_FLOAT(0xD5C4A1, 1.0f),             /* header_footer_separator */
   COLOR_HEX_TO_FLOAT(0xEEDDBB, 1.0f),             /* text */
   COLOR_HEX_TO_FLOAT(0xBB4400, 1.0f),             /* selection */
   COLOR_HEX_TO_FLOAT(0xBB4400, 1.0f),             /* selection_border */
   COLOR_HEX_TO_FLOAT(0x282828, 1.0f),             /* entries_border */
   COLOR_HEX_TO_FLOAT(0xEBDBB2, 1.0f),             /* entries_icon */
   COLOR_HEX_TO_FLOAT(0x33CC11, 1.0f),             /* text_selected */
   COLOR_HEX_TO_FLOAT(0x32302F, 1.0f),             /* message_background */

   /* RGBA colors for text */
   0xEEDDBBFF,                                     /* text_rgba */
   0x33CC11FF,                                     /* text_selected_rgba */
...
ozone_theme_t ozone_theme_boysenberry = {
   ...
   ozone_background_libks_running_boysenberry, /* background_libks_running */
...
ozone_theme_t ozone_theme_hacking_the_kernel = {
   ...
   ozone_background_libks_running_hacking_the_kernel, /* background_libks_running */
...
ozone_theme_t ozone_theme_twilight_zone = {
   ...
   ozone_background_libks_running_twilight_zone, /* background_libks_running */
      ...
      ozone_handle_t *ozone, float framebuffer_opacity)
{
   ...
   if (!ozone || !ozone->theme->background_libks_running)
      return;

   background                      = 
      ozone->theme->background_libks_running;
